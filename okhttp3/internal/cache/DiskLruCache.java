...
public final class DiskLruCache implements Closeable, Flushable {
    ...
    public final synchronized Editor edit(String r10, long expectedSequenceNumber) throws IOException {
        ...
        if (!this.mostRecentTrimFailed && !this.mostRecentRebuildFailed) {
            BufferedSink bufferedSink = this.journalWriter;
            Intrinsics.checkNotNull(bufferedSink);
            bufferedSink.writeUtf8(DIRTY).writeByte(32).writeUtf8(r10).writeByte(10);
            bufferedSink.flush();
    ...
    public final synchronized boolean remove(String r6) throws IOException {
        Intrinsics.checkNotNullParameter(r6, "key");
        initialize();
        checkNotClosed();
        validateKey(r6);
        Entry entry = this.lruEntries.get(r6);
        if (entry == null) {
            return false;
        }
    ...
    private final void validateKey(String r3) {
        if (LEGAL_KEY_PATTERN.matches(r3)) {
            return;
        }
