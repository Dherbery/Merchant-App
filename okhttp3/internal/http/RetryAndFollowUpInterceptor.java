    ...
    */
    public okhttp3.Response intercept(okhttp3.Interceptor.Chain r11) throws java.io.IOException {
        ...
        L1c:
            ...
            boolean r6 = r1.getCanceled()     // Catch: java.lang.Throwable -> Le8
            if (r6 != 0) goto Lde
            okhttp3.Response r0 = r11.proceed(r0)     // Catch: java.io.IOException -> L9c okhttp3.internal.connection.RouteException -> Lb8 java.lang.Throwable -> Le8
            if (r7 == 0) goto L43
            okhttp3.Response$Builder r0 = r0.newBuilder()     // Catch: java.lang.Throwable -> Le8
            okhttp3.Response$Builder r6 = r7.newBuilder()     // Catch: java.lang.Throwable -> Le8
            okhttp3.Response$Builder r6 = r6.body(r2)     // Catch: java.lang.Throwable -> Le8
            okhttp3.Response r6 = r6.build()     // Catch: java.lang.Throwable -> Le8
            okhttp3.Response$Builder r0 = r0.priorResponse(r6)     // Catch: java.lang.Throwable -> Le8
            okhttp3.Response r0 = r0.build()     // Catch: java.lang.Throwable -> Le8
        L43:
            r7 = r0
            okhttp3.internal.connection.Exchange r0 = r1.getInterceptorScopedExchange()     // Catch: java.lang.Throwable -> Le8
            okhttp3.Request r6 = r10.followUpRequest(r7, r0)     // Catch: java.lang.Throwable -> Le8
            if (r6 != 0) goto L5d
            if (r0 == 0) goto L59
            boolean r11 = r0.getIsDuplex()     // Catch: java.lang.Throwable -> Le8
            if (r11 == 0) goto L59
            r1.timeoutEarlyExit()     // Catch: java.lang.Throwable -> Le8
        L59:
            r1.exitNetworkInterceptorExchange$okhttp(r4)
            return r7
        L5d:
            okhttp3.RequestBody r0 = r6.body()     // Catch: java.lang.Throwable -> Le8
            if (r0 == 0) goto L6d
            boolean r0 = r0.isOneShot()     // Catch: java.lang.Throwable -> Le8
            if (r0 == 0) goto L6d
            r1.exitNetworkInterceptorExchange$okhttp(r4)
            return r7
        L6d:
            okhttp3.ResponseBody r0 = r7.body()     // Catch: java.lang.Throwable -> Le8
            if (r0 == 0) goto L78
            java.io.Closeable r0 = (java.io.Closeable) r0     // Catch: java.lang.Throwable -> Le8
            okhttp3.internal.Util.closeQuietly(r0)     // Catch: java.lang.Throwable -> Le8
        L78:
            int r8 = r8 + 1
            r0 = 20
            if (r8 > r0) goto L83
            ...
            goto L1b
        L83:
            java.net.ProtocolException r11 = new java.net.ProtocolException     // Catch: java.lang.Throwable -> Le8
            ...
            r11.<init>(r0)     // Catch: java.lang.Throwable -> Le8
            java.lang.Throwable r11 = (java.lang.Throwable) r11     // Catch: java.lang.Throwable -> Le8
            throw r11     // Catch: java.lang.Throwable -> Le8
        L9c:
            r6 = move-exception
            boolean r9 = r6 instanceof okhttp3.internal.http2.ConnectionShutdownException     // Catch: java.lang.Throwable -> Le8
            if (r9 != 0) goto La3
            r9 = r5
            goto La4
        La3:
            r9 = r4
        La4:
            boolean r9 = r10.recover(r6, r1, r0, r9)     // Catch: java.lang.Throwable -> Le8
            if (r9 == 0) goto Lb1
            java.util.Collection r3 = (java.util.Collection) r3     // Catch: java.lang.Throwable -> Le8
            java.util.List r3 = kotlin.collections.CollectionsKt.plus(r3, r6)     // Catch: java.lang.Throwable -> Le8
            goto Lcd
        Lb1:
            java.lang.Exception r6 = (java.lang.Exception) r6     // Catch: java.lang.Throwable -> Le8
            java.lang.Throwable r11 = okhttp3.internal.Util.withSuppressed(r6, r3)     // Catch: java.lang.Throwable -> Le8
            throw r11     // Catch: java.lang.Throwable -> Le8
        Lb8:
            r6 = move-exception
            java.io.IOException r9 = r6.getLastConnectException()     // Catch: java.lang.Throwable -> Le8
            boolean r9 = r10.recover(r9, r1, r0, r4)     // Catch: java.lang.Throwable -> Le8
            if (r9 == 0) goto Ld3
            java.util.Collection r3 = (java.util.Collection) r3     // Catch: java.lang.Throwable -> Le8
            java.io.IOException r6 = r6.getFirstConnectException()     // Catch: java.lang.Throwable -> Le8
            java.util.List r3 = kotlin.collections.CollectionsKt.plus(r3, r6)     // Catch: java.lang.Throwable -> Le8
        Lcd:
            r1.exitNetworkInterceptorExchange$okhttp(r5)
            r6 = r4
            goto L1c
        Ld3:
            java.io.IOException r11 = r6.getFirstConnectException()     // Catch: java.lang.Throwable -> Le8
            java.lang.Exception r11 = (java.lang.Exception) r11     // Catch: java.lang.Throwable -> Le8
            java.lang.Throwable r11 = okhttp3.internal.Util.withSuppressed(r11, r3)     // Catch: java.lang.Throwable -> Le8
            throw r11     // Catch: java.lang.Throwable -> Le8
        Lde:
            java.io.IOException r11 = new java.io.IOException     // Catch: java.lang.Throwable -> Le8
