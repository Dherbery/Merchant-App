...
public final class ClassValueCache<T> implements SerializerCache<T> {
    ...
    public static final /* synthetic */ Function1 access$getCompute$p(ClassValueCache classValueCache) {
        return classValueCache.compute;
    }
    ...
    private final ClassValueCache$initClassValue$1 initClassValue() {
        return new ClassValue<CacheEntry<T>>(this) { // from class: kotlinx.serialization.internal.ClassValueCache$initClassValue$1
            ...
            protected CacheEntry<T> computeValue(Class<?> type) {
                ...
                return new CacheEntry<>((KSerializer) ClassValueCache.access$getCompute$p(this.this$0).invoke(JvmClassMappingKt.getKotlinClass(type)));
            }
        };
    }
