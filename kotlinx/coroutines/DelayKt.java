...
public final class DelayKt {
    ...
    */
    ...
    public static final Object delay(long j, Continuation<? super Unit> continuation) {
        ...
        if (j < Long.MAX_VALUE) {
            getDelay(cancellableContinuationImpl2.getContext()).mo2928scheduleResumeAfterDelay(j, cancellableContinuationImpl2);
        }
    ...
    public static final Object m2859delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object delay = delay(m2860toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m2860toDelayMillisLRDsOJo(long j) {
        if (Duration.m2695compareToLRDsOJo(j, Duration.INSTANCE.m2798getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m2714getInWholeMillisecondsimpl(j), 1L);
        }
        return 0L;
    }
}
