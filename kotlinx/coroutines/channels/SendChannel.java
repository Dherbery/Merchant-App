...
public interface SendChannel<E> {
    ...
    Object mo2872trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) {
            Object mo2872trySendJP2dKIU = sendChannel.mo2872trySendJP2dKIU(e);
            if (ChannelResult.m2892isSuccessimpl(mo2872trySendJP2dKIU)) {
                return true;
            }
            Throwable m2886exceptionOrNullimpl = ChannelResult.m2886exceptionOrNullimpl(mo2872trySendJP2dKIU);
