...
public class ChannelCoroutine<E> extends AbstractCoroutine<Unit> implements Channel<E> {
    ...
    public Object mo2876receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
        Object obj = this._channel.mo2876receiveCatchingJP2dKIU(continuation);
    ...
    public Object mo2877tryReceivePtdJZtk() {
        return this._channel.mo2877tryReceivePtdJZtk();
    }

    @Override // kotlinx.coroutines.channels.SendChannel
    /* renamed from: trySend-JP2dKIU */
    public Object mo2872trySendJP2dKIU(E element) {
        return this._channel.mo2872trySendJP2dKIU(element);
    }
