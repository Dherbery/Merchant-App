...
@DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__DelayKt$sample$2", f = "Delay.kt", i = {0, 0, 0, 0}, l = {423}, m = "invokeSuspend", n = {"downstream", DiagnosticsEntry.Histogram.VALUES_KEY, "lastValue", "ticker"}, s = {"L$0", "L$1", "L$2", "L$3"})
