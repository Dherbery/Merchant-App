...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        try {
            ...
            obj = Result.m1318constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            obj = Result.m1318constructorimpl(ResultKt.createFailure(th));
        }
        ...
        try {
            ...
            obj2 = Result.m1318constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.INSTANCE;
            obj2 = Result.m1318constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m1321exceptionOrNullimpl(obj2) == null) {
            obj3 = obj2;
        }
