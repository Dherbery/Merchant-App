...
public final class ExceptionsConstructorKt {
    ...
    public static final <E extends Throwable> E tryCopyException(E e) {
        ...
        if (e instanceof CopyableThrowable) {
            try {
                ...
                m1318constructorimpl = Result.m1318constructorimpl(((CopyableThrowable) e).createCopy());
            } catch (Throwable th) {
        ...
        return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt$safeCtor$1
            ...
            public final Throwable invoke(Throwable th) {
                ...
                try {
                    ...
                    m1318constructorimpl = Result.m1318constructorimpl(invoke);
                } catch (Throwable th2) {
                    Result.Companion companion2 = Result.INSTANCE;
                    m1318constructorimpl = Result.m1318constructorimpl(ResultKt.createFailure(th2));
                }
                return (Throwable) (Result.m1324isFailureimpl(m1318constructorimpl) ? null : m1318constructorimpl);
            }
        };
    }
    ...
    private static final int fieldsCountOrDefault(Class<?> cls, int i) {
        ...
        try {
            Result.Companion companion = Result.INSTANCE;
            m1318constructorimpl = Result.m1318constructorimpl(Integer.valueOf(fieldsCount$default(cls, 0, 1, null)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            m1318constructorimpl = Result.m1318constructorimpl(ResultKt.createFailure(th));
        }
        ...
        if (Result.m1324isFailureimpl(m1318constructorimpl)) {
            m1318constructorimpl = valueOf;
        }
        return ((Number) m1318constructorimpl).intValue();
    }
