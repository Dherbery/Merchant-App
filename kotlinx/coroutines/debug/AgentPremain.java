...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            m1318constructorimpl = Result.m1318constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            m1318constructorimpl = Result.m1318constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m1324isFailureimpl(m1318constructorimpl) ? null : m1318constructorimpl);
