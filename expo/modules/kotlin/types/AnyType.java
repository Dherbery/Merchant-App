...
public final class AnyType {
    ...
    private final Lazy expo.modules.annotation.Config.converterProviderFunctionName java.lang.String;
    private final KType kType;

    public AnyType(KType kType) {
        Intrinsics.checkNotNullParameter(kType, "kType");
        this.kType = kType;
        this.expo.modules.annotation.Config.converterProviderFunctionName java.lang.String = LazyKt.lazy(new Function0<TypeConverter<?>>() { // from class: expo.modules.kotlin.types.AnyType$converter$2
    ...
    private final TypeConverter<?> getConverter() {
        return (TypeConverter) this.expo.modules.annotation.Config.converterProviderFunctionName java.lang.String.getValue();
    }
