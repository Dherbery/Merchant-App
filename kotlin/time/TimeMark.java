...
public interface TimeMark {
    ...
    TimeMark mo2686minusLRDsOJo(long duration);

    /* renamed from: plus-LRDsOJo */
    TimeMark mo2688plusLRDsOJo(long duration);
    ...
    public static final class DefaultImpls {
        ...
        public static TimeMark m2833plusLRDsOJo(TimeMark timeMark, long j) {
            return new AdjustedTimeMark(timeMark, j, null);
        }

        /* renamed from: minus-LRDsOJo, reason: not valid java name */
        public static TimeMark m2832minusLRDsOJo(TimeMark timeMark, long j) {
            return timeMark.mo2688plusLRDsOJo(Duration.m2748unaryMinusUwyO8pc(j));
        }

        public static boolean hasPassedNow(TimeMark timeMark) {
            return !Duration.m2729isNegativeimpl(timeMark.mo2685elapsedNowUwyO8pc());
        }
