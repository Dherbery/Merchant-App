...
public final class MonotonicTimeSource implements TimeSource.WithComparableMarks {
    ...
    public /* bridge */ /* synthetic */ ComparableTimeMark markNow() {
        return TimeSource.Monotonic.ValueTimeMark.m2835boximpl(m2829markNowz9LOYto());
    }
    ...
    public long m2829markNowz9LOYto() {
        return TimeSource.Monotonic.ValueTimeMark.m2838constructorimpl(read());
    }

    /* renamed from: elapsedFrom-6eNON_k, reason: not valid java name */
    public final long m2828elapsedFrom6eNON_k(long timeMark) {
        return LongSaturatedMathKt.saturatingDiff(read(), timeMark);
    }

    /* renamed from: differenceBetween-fRLX17w, reason: not valid java name */
    public final long m2827differenceBetweenfRLX17w(long one, long another) {
        return LongSaturatedMathKt.saturatingOriginsDiff(one, another);
    }

    /* renamed from: adjustReading-6QKq23U, reason: not valid java name */
    public final long m2826adjustReading6QKq23U(long timeMark, long duration) {
        return TimeSource.Monotonic.ValueTimeMark.m2838constructorimpl(LongSaturatedMathKt.m2824saturatingAddpTJri5U(timeMark, duration));
    }
}
