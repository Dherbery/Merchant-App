...
public final class TypeUtilsKt {
    ...
    private static final void extractTypeParametersFromUpperBounds(KotlinType kotlinType, KotlinType kotlinType2, Set<TypeParameterDescriptor> set, Set<? extends TypeParameterDescriptor> set2) {
        ClassifierDescriptor mo2646getDeclarationDescriptor = kotlinType.getConstructor().mo2646getDeclarationDescriptor();
        if (mo2646getDeclarationDescriptor instanceof TypeParameterDescriptor) {
            if (!Intrinsics.areEqual(kotlinType.getConstructor(), kotlinType2.getConstructor())) {
                set.add(mo2646getDeclarationDescriptor);
                return;
            }
            for (KotlinType upperBound : ((TypeParameterDescriptor) mo2646getDeclarationDescriptor).getUpperBounds()) {
                Intrinsics.checkNotNullExpressionValue(upperBound, "upperBound");
                extractTypeParametersFromUpperBounds(upperBound, kotlinType2, set, set2);
            }
            return;
        }
        ClassifierDescriptor mo2646getDeclarationDescriptor2 = kotlinType.getConstructor().mo2646getDeclarationDescriptor();
        ClassifierDescriptorWithTypeParameters classifierDescriptorWithTypeParameters = mo2646getDeclarationDescriptor2 instanceof ClassifierDescriptorWithTypeParameters ? (ClassifierDescriptorWithTypeParameters) mo2646getDeclarationDescriptor2 : null;
    ...
    private static final boolean containsSelfTypeParameter(KotlinType kotlinType, TypeConstructor typeConstructor, Set<? extends TypeParameterDescriptor> set) {
        ...
        ClassifierDescriptor mo2646getDeclarationDescriptor = kotlinType.getConstructor().mo2646getDeclarationDescriptor();
        ClassifierDescriptorWithTypeParameters classifierDescriptorWithTypeParameters = mo2646getDeclarationDescriptor instanceof ClassifierDescriptorWithTypeParameters ? (ClassifierDescriptorWithTypeParameters) mo2646getDeclarationDescriptor : null;
        List<TypeParameterDescriptor> declaredTypeParameters = classifierDescriptorWithTypeParameters != null ? classifierDescriptorWithTypeParameters.getDeclaredTypeParameters() : null;
    ...
    public static final boolean containsTypeAliasParameters(KotlinType kotlinType) {
        ...
        return contains(kotlinType, new Function1<UnwrappedType, Boolean>() { // from class: kotlin.reflect.jvm.internal.impl.types.typeUtil.TypeUtilsKt$containsTypeAliasParameters$1
            ...
            public final Boolean invoke(UnwrappedType it) {
                ...
                ClassifierDescriptor mo2646getDeclarationDescriptor = it.getConstructor().mo2646getDeclarationDescriptor();
                return Boolean.valueOf(mo2646getDeclarationDescriptor != null ? TypeUtilsKt.isTypeAliasParameter(mo2646getDeclarationDescriptor) : false);
            }
        });
    }
    ...
    public static final boolean requiresTypeAliasExpansion(KotlinType kotlinType) {
        ...
        return contains(kotlinType, new Function1<UnwrappedType, Boolean>() { // from class: kotlin.reflect.jvm.internal.impl.types.typeUtil.TypeUtilsKt$requiresTypeAliasExpansion$1
            ...
            public final Boolean invoke(UnwrappedType it) {
                ...
                ClassifierDescriptor mo2646getDeclarationDescriptor = it.getConstructor().mo2646getDeclarationDescriptor();
                boolean z = false;
                if (mo2646getDeclarationDescriptor != null && ((mo2646getDeclarationDescriptor instanceof TypeAliasDescriptor) || (mo2646getDeclarationDescriptor instanceof TypeParameterDescriptor))) {
                    z = true;
                }
    ...
    */
    public static final kotlin.reflect.jvm.internal.impl.types.KotlinType getRepresentativeUpperBound(kotlin.reflect.jvm.internal.impl.descriptors.TypeParameterDescriptor r7) {
        ...
        L20:
            ...
            kotlin.reflect.jvm.internal.impl.descriptors.ClassifierDescriptor r4 = r4.mo2646getDeclarationDescriptor()
    ...
    public static final KotlinType replaceArgumentsWithStarProjections(KotlinType kotlinType) {
        ...
        if (unwrap instanceof FlexibleType) {
            ...
            if (!lowerBound.getConstructor().getParameters().isEmpty() && lowerBound.getConstructor().mo2646getDeclarationDescriptor() != null) {
            ...
            if (!upperBound.getConstructor().getParameters().isEmpty() && upperBound.getConstructor().mo2646getDeclarationDescriptor() != null) {
            ...
            if (!simpleType2.getConstructor().getParameters().isEmpty() && simpleType2.getConstructor().mo2646getDeclarationDescriptor() != null) {
