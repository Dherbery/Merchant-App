...
public abstract class AbstractClassTypeConstructor extends AbstractTypeConstructor implements TypeConstructor {
    ...
    */
    ...
    public abstract ClassDescriptor mo2646getDeclarationDescriptor();
    ...
    public KotlinBuiltIns getBuiltIns() {
        KotlinBuiltIns builtIns = DescriptorUtilsKt.getBuiltIns(mo2646getDeclarationDescriptor());
        if (builtIns == null) {
            $$$reportNull$$$0(1);
        }
        return builtIns;
    ...
    protected boolean isSameClassifier(ClassifierDescriptor classifierDescriptor) {
        ...
        return (classifierDescriptor instanceof ClassDescriptor) && areFqNamesEqual(mo2646getDeclarationDescriptor(), classifierDescriptor);
    }

    @Override // kotlin.reflect.jvm.internal.impl.types.AbstractTypeConstructor
    protected Collection<KotlinType> getAdditionalNeighboursInSupertypeGraph(boolean z) {
        DeclarationDescriptor containingDeclaration = mo2646getDeclarationDescriptor().getContainingDeclaration();
        ...
        ClassDescriptor mo2639getCompanionObjectDescriptor = classDescriptor.mo2639getCompanionObjectDescriptor();
        if (z && mo2639getCompanionObjectDescriptor != null) {
            smartList.add(mo2639getCompanionObjectDescriptor.getDefaultType());
        }
        return smartList;
    }
    ...
    public KotlinType defaultSupertypeIfEmpty() {
        if (KotlinBuiltIns.isSpecialClassWithNoSupertypes(mo2646getDeclarationDescriptor())) {
            return null;
        }
