    ...
    private final SimpleType transformToNewType(SimpleType simpleType) {
        ...
        if (constructor instanceof CapturedTypeConstructorImpl) {
            ...
            if (capturedTypeConstructorImpl.getNewTypeConstructor() == null) {
                ...
                Collection<KotlinType> mo2647getSupertypes = capturedTypeConstructorImpl.mo2647getSupertypes();
                ArrayList arrayList = new ArrayList(CollectionsKt.collectionSizeOrDefault(mo2647getSupertypes, 10));
        ...
        if (constructor instanceof IntegerValueTypeConstructor) {
            Collection<KotlinType> mo2647getSupertypes2 = ((IntegerValueTypeConstructor) constructor).mo2647getSupertypes();
            ArrayList arrayList2 = new ArrayList(CollectionsKt.collectionSizeOrDefault(mo2647getSupertypes2, 10));
            Iterator<T> it2 = mo2647getSupertypes2.iterator();
            while (it2.hasNext()) {
        ...
        Collection<KotlinType> mo2647getSupertypes3 = intersectionTypeConstructor2.mo2647getSupertypes();
        ArrayList arrayList3 = new ArrayList(CollectionsKt.collectionSizeOrDefault(mo2647getSupertypes3, 10));
        Iterator<T> it3 = mo2647getSupertypes3.iterator();
        while (it3.hasNext()) {
