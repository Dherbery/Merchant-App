    ...
    public final SimpleType intersectTypes$descriptors(List<? extends SimpleType> types) {
        ...
        for (SimpleType simpleType : types) {
            if (simpleType.getConstructor() instanceof IntersectionTypeConstructor) {
                Collection<KotlinType> mo2647getSupertypes = simpleType.getConstructor().mo2647getSupertypes();
                Intrinsics.checkNotNullExpressionValue(mo2647getSupertypes, "type.constructor.supertypes");
                Collection<KotlinType> collection = mo2647getSupertypes;
