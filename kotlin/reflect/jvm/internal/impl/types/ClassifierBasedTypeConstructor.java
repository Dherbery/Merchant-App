...
public abstract class ClassifierBasedTypeConstructor implements TypeConstructor {
    ...
    public abstract ClassifierDescriptor mo2646getDeclarationDescriptor();
    ...
    public int hashCode() {
        ...
        ClassifierDescriptor mo2646getDeclarationDescriptor = mo2646getDeclarationDescriptor();
        if (hasMeaningfulFqName(mo2646getDeclarationDescriptor)) {
            identityHashCode = DescriptorUtils.getFqName(mo2646getDeclarationDescriptor).hashCode();
        } else {
    ...
    public boolean equals(Object obj) {
        ...
        ClassifierDescriptor mo2646getDeclarationDescriptor = mo2646getDeclarationDescriptor();
        ClassifierDescriptor mo2646getDeclarationDescriptor2 = typeConstructor.mo2646getDeclarationDescriptor();
        if (mo2646getDeclarationDescriptor2 != null && hasMeaningfulFqName(mo2646getDeclarationDescriptor) && hasMeaningfulFqName(mo2646getDeclarationDescriptor2)) {
            return isSameClassifier(mo2646getDeclarationDescriptor2);
        }
        return false;
    }
