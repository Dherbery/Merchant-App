...
public final class DescriptorRendererImpl extends DescriptorRenderer implements DescriptorRendererOptions {
    ...
    */
    ...
    public String renderTypeConstructor(TypeConstructor typeConstructor) {
        ...
        ClassifierDescriptor mo2646getDeclarationDescriptor = typeConstructor.mo2646getDeclarationDescriptor();
        if (mo2646getDeclarationDescriptor instanceof TypeParameterDescriptor ? true : mo2646getDeclarationDescriptor instanceof ClassDescriptor ? true : mo2646getDeclarationDescriptor instanceof TypeAliasDescriptor) {
            return renderClassifierName(mo2646getDeclarationDescriptor);
        }
        if (mo2646getDeclarationDescriptor == null) {
        ...
        throw new IllegalStateException(("Unexpected classifier: " + mo2646getDeclarationDescriptor.getClass()).toString());
    }
    ...
    public String renderAnnotation(AnnotationDescriptor annotation, AnnotationUseSiteTarget annotationUseSiteTarget) {
        ...
        if (getVerbose() && (KotlinTypeKt.isError(type) || (type.getConstructor().mo2646getDeclarationDescriptor() instanceof NotFoundClasses.MockClassDescriptor))) {
    ...
    private final List<String> renderAndSortAnnotationArguments(AnnotationDescriptor annotationDescriptor) {
        ClassConstructorDescriptor mo2640getUnsubstitutedPrimaryConstructor;
        ...
        if (annotationClass != null && (mo2640getUnsubstitutedPrimaryConstructor = annotationClass.mo2640getUnsubstitutedPrimaryConstructor()) != null && (valueParameters = mo2640getUnsubstitutedPrimaryConstructor.getValueParameters()) != null) {
    ...
    */
    ...
    private final void renderInitializer(VariableDescriptor variableDescriptor, StringBuilder sb) {
        ConstantValue<?> mo2642getCompileTimeInitializer;
        if (!getIncludePropertyConstant() || (mo2642getCompileTimeInitializer = variableDescriptor.mo2642getCompileTimeInitializer()) == null) {
            return;
        }
        sb.append(" = ");
        sb.append(escape(renderConstant(mo2642getCompileTimeInitializer)));
    }
    ...
    public final void renderClass(ClassDescriptor classDescriptor, StringBuilder sb) {
        ...
        if (!classDescriptor.getKind().isSingleton() && getClassWithPrimaryConstructor() && (mo2640getUnsubstitutedPrimaryConstructor = classDescriptor.mo2640getUnsubstitutedPrimaryConstructor()) != null) {
            sb.append(MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR);
            renderAnnotations$default(this, sb, mo2640getUnsubstitutedPrimaryConstructor, null, 2, null);
            DescriptorVisibility visibility2 = mo2640getUnsubstitutedPrimaryConstructor.getVisibility();
            Intrinsics.checkNotNullExpressionValue(visibility2, "primaryConstructor.visibility");
            renderVisibility(visibility2, sb);
            sb.append(renderKeyword("constructor"));
            List<ValueParameterDescriptor> valueParameters = mo2640getUnsubstitutedPrimaryConstructor.getValueParameters();
            Intrinsics.checkNotNullExpressionValue(valueParameters, "primaryConstructor.valueParameters");
            renderValueParameters(valueParameters, mo2640getUnsubstitutedPrimaryConstructor.hasSynthesizedParameterNames(), sb);
        }
    ...
    private final void renderSuperTypes(ClassDescriptor classDescriptor, StringBuilder sb) {
        ...
        Collection<KotlinType> mo2647getSupertypes = classDescriptor.getTypeConstructor().mo2647getSupertypes();
        Intrinsics.checkNotNullExpressionValue(mo2647getSupertypes, "klass.typeConstructor.supertypes");
        if (mo2647getSupertypes.isEmpty()) {
            return;
        }
        if (mo2647getSupertypes.size() == 1 && KotlinBuiltIns.isAnyOrNullableAny(mo2647getSupertypes.iterator().next())) {
            return;
        }
        renderSpaceIfNeeded(sb);
        sb.append(": ");
        CollectionsKt.joinTo(mo2647getSupertypes, sb, (r14 & 2) != 0 ? ", " : ", ", (r14 & 4) != 0 ? "" : null, (r14 & 8) != 0 ? "" : null, (r14 & 16) != 0 ? -1 : 0, (r14 & 32) != 0 ? "..." : null, (r14 & 64) != 0 ? null : new Function1<KotlinType, CharSequence>() { // from class: kotlin.reflect.jvm.internal.impl.renderer.DescriptorRendererImpl$renderSuperTypes$1
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(1);
            }
