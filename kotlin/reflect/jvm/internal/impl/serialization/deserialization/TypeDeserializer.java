...
public final class TypeDeserializer {
    ...
    public final SimpleType simpleType(final ProtoBuf.Type proto, boolean z) {
        ...
        if (ErrorUtils.isError(typeConstructor.mo2646getDeclarationDescriptor())) {
        ...
        boolean z2 = true;
        if (z && (mo2646getDeclarationDescriptor instanceof TypeAliasDescriptor)) {
            KotlinTypeFactory kotlinTypeFactory = KotlinTypeFactory.INSTANCE;
            SimpleType computeExpandedType = KotlinTypeFactory.computeExpandedType((TypeAliasDescriptor) mo2646getDeclarationDescriptor, list);
            ...
            if (bool.booleanValue()) {
                ...
                if (bool2.booleanValue()) {
                    DefinitelyNotNullType makeDefinitelyNotNull = DefinitelyNotNullType.Companion.makeDefinitelyNotNull(simpleType$default, true);
    ...
    */
    private final kotlin.reflect.jvm.internal.impl.types.SimpleType transformRuntimeFunctionTypeToSuspendFunction(kotlin.reflect.jvm.internal.impl.types.KotlinType r6) {
        ...
        L14:
            ...
            kotlin.reflect.jvm.internal.impl.descriptors.ClassifierDescriptor r2 = r2.mo2646getDeclarationDescriptor()
            if (r2 == 0) goto L25
