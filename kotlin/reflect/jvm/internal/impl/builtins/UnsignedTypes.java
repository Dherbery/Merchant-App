...
public final class UnsignedTypes {
    ...
    public static final boolean isUnsignedType(KotlinType type) {
        ClassifierDescriptor mo2646getDeclarationDescriptor;
        Intrinsics.checkNotNullParameter(type, "type");
        if (TypeUtils.noExpectedType(type) || (mo2646getDeclarationDescriptor = type.getConstructor().mo2646getDeclarationDescriptor()) == null) {
            return false;
        }
        return INSTANCE.isUnsignedClass(mo2646getDeclarationDescriptor);
    }
