...
public final class FunctionTypesKt {
    public static final boolean isFunctionType(KotlinType kotlinType) {
        ...
        return (mo2646getDeclarationDescriptor != null ? getFunctionalClassKind(mo2646getDeclarationDescriptor) : null) == FunctionClassKind.Function;
    }

    public static final boolean isSuspendFunctionType(KotlinType kotlinType) {
        Intrinsics.checkNotNullParameter(kotlinType, "<this>");
        ClassifierDescriptor mo2646getDeclarationDescriptor = kotlinType.getConstructor().mo2646getDeclarationDescriptor();
        return (mo2646getDeclarationDescriptor != null ? getFunctionalClassKind(mo2646getDeclarationDescriptor) : null) == FunctionClassKind.SuspendFunction;
    }

    public static final boolean isBuiltinFunctionalType(KotlinType kotlinType) {
        Intrinsics.checkNotNullParameter(kotlinType, "<this>");
        ClassifierDescriptor mo2646getDeclarationDescriptor = kotlinType.getConstructor().mo2646getDeclarationDescriptor();
        return mo2646getDeclarationDescriptor != null && isBuiltinFunctionalClassDescriptor(mo2646getDeclarationDescriptor);
    }
    ...
    private static final boolean isTypeAnnotatedWithExtensionFunctionType(KotlinType kotlinType) {
        return kotlinType.getAnnotations().mo2641findAnnotation(StandardNames.FqNames.extensionFunctionType) != null;
    }
    ...
    public static final int contextFunctionTypeParamsCount(KotlinType kotlinType) {
        Intrinsics.checkNotNullParameter(kotlinType, "<this>");
        AnnotationDescriptor mo2641findAnnotation = kotlinType.getAnnotations().mo2641findAnnotation(StandardNames.FqNames.contextFunctionTypeParams);
        if (mo2641findAnnotation == null) {
            return 0;
        }
        ConstantValue constantValue = (ConstantValue) MapsKt.getValue(mo2641findAnnotation.getAllValueArguments(), StandardNames.CONTEXT_FUNCTION_TYPE_PARAMETER_COUNT_NAME);
    ...
    public static final Name extractParameterNameFromFunctionTypeArgument(KotlinType kotlinType) {
        String value;
        Intrinsics.checkNotNullParameter(kotlinType, "<this>");
        AnnotationDescriptor mo2641findAnnotation = kotlinType.getAnnotations().mo2641findAnnotation(StandardNames.FqNames.parameterName);
        if (mo2641findAnnotation == null) {
            return null;
        }
        Object singleOrNull = CollectionsKt.singleOrNull(mo2641findAnnotation.getAllValueArguments().values());
