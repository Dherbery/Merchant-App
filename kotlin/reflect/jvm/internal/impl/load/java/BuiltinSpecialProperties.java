...
public final class BuiltinSpecialProperties {
    ...
    static {
        ...
        child4 = BuiltinSpecialPropertiesKt.child(StandardNames.FqNames.map, DiagnosticsEntry.Histogram.VALUES_KEY);
        child5 = BuiltinSpecialPropertiesKt.child(StandardNames.FqNames.map, "entries");
        Map<FqName, Name> mapOf = MapsKt.mapOf(TuplesKt.to(childSafe, Name.identifier("name")), TuplesKt.to(childSafe2, Name.identifier("ordinal")), TuplesKt.to(child, Name.identifier("size")), TuplesKt.to(child2, Name.identifier("size")), TuplesKt.to(childSafe3, Name.identifier(SessionDescription.ATTR_LENGTH)), TuplesKt.to(child3, Name.identifier("keySet")), TuplesKt.to(child4, Name.identifier(DiagnosticsEntry.Histogram.VALUES_KEY)), TuplesKt.to(child5, Name.identifier("entrySet")));
