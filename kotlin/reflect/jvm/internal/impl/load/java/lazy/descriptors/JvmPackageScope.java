...
public final class JvmPackageScope implements MemberScope {
    ...
    public ClassifierDescriptor mo2648getContributedClassifier(Name name, LookupLocation location) {
        ...
        ClassDescriptor mo2648getContributedClassifier = this.javaScope.mo2648getContributedClassifier(name, location);
        if (mo2648getContributedClassifier != null) {
            return mo2648getContributedClassifier;
        }
        ClassifierDescriptor classifierDescriptor = null;
        for (MemberScope memberScope : getKotlinScopes()) {
            ClassifierDescriptor contributedClassifier = memberScope.mo2648getContributedClassifier(name, location);
