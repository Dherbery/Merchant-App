...
public final class SignatureEnhancement {
    ...
    /* JADX WARN: Removed duplicated region for block: B:86:0x020c A[ADDED_TO_REGION] */
    ...
    private final boolean containsFunctionN(KotlinType kotlinType) {
        return TypeUtils.contains(kotlinType, new Function1<UnwrappedType, Boolean>() { // from class: kotlin.reflect.jvm.internal.impl.load.java.typeEnhancement.SignatureEnhancement$containsFunctionN$1
            ...
            public final Boolean invoke(UnwrappedType unwrappedType) {
                ...
                if (Intrinsics.areEqual(mo2646getDeclarationDescriptor.getName(), JavaToKotlinClassMap.INSTANCE.getFUNCTION_N_FQ_NAME().shortName()) && Intrinsics.areEqual(DescriptorUtilsKt.fqNameOrNull(mo2646getDeclarationDescriptor), JavaToKotlinClassMap.INSTANCE.getFUNCTION_N_FQ_NAME())) {
                    z = true;
                }
