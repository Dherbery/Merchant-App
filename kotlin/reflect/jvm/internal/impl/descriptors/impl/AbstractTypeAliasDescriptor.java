...
public abstract class AbstractTypeAliasDescriptor extends DeclarationDescriptorNonRootImpl implements TypeAliasDescriptor {
    ...
    public AbstractTypeAliasDescriptor(DeclarationDescriptor containingDeclaration, Annotations annotations, Name name, SourceElement sourceElement, DescriptorVisibility visibilityImpl) {
        ...
        this.typeConstructor = new TypeConstructor() { // from class: kotlin.reflect.jvm.internal.impl.descriptors.impl.AbstractTypeAliasDescriptor$typeConstructor$1
            ...
            public TypeAliasDescriptor mo2646getDeclarationDescriptor() {
            ...
            public Collection<KotlinType> mo2647getSupertypes() {
                Collection<KotlinType> mo2647getSupertypes = mo2646getDeclarationDescriptor().getUnderlyingType().getConstructor().mo2647getSupertypes();
                Intrinsics.checkNotNullExpressionValue(mo2647getSupertypes, "declarationDescriptor.un…pe.constructor.supertypes");
                return mo2647getSupertypes;
            }

            @Override // kotlin.reflect.jvm.internal.impl.types.TypeConstructor
            public KotlinBuiltIns getBuiltIns() {
                return DescriptorUtilsKt.getBuiltIns(mo2646getDeclarationDescriptor());
            }

            public String toString() {
                return "[typealias " + mo2646getDeclarationDescriptor().getName().asString() + AbstractJsonLexerKt.END_LIST;
            }
        ...
        return TypeUtils.contains(getUnderlyingType(), new Function1<UnwrappedType, Boolean>() { // from class: kotlin.reflect.jvm.internal.impl.descriptors.impl.AbstractTypeAliasDescriptor$isInner$1
            ...
            public final Boolean invoke(UnwrappedType type) {
                ...
                if (!KotlinTypeKt.isError(type)) {
                    ...
                    ClassifierDescriptor mo2646getDeclarationDescriptor = type.getConstructor().mo2646getDeclarationDescriptor();
                    if ((mo2646getDeclarationDescriptor instanceof TypeParameterDescriptor) && !Intrinsics.areEqual(((TypeParameterDescriptor) mo2646getDeclarationDescriptor).getContainingDeclaration(), abstractTypeAliasDescriptor)) {
                        z = true;
                    }
                }
