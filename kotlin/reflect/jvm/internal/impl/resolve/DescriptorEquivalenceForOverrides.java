...
public final class DescriptorEquivalenceForOverrides {
    ...
    public static final boolean areCallableDescriptorsEquivalent$lambda$0(boolean z, final CallableDescriptor a, final CallableDescriptor b, TypeConstructor c1, TypeConstructor c2) {
        ...
        ClassifierDescriptor mo2646getDeclarationDescriptor = c1.mo2646getDeclarationDescriptor();
        ClassifierDescriptor mo2646getDeclarationDescriptor2 = c2.mo2646getDeclarationDescriptor();
        if ((mo2646getDeclarationDescriptor instanceof TypeParameterDescriptor) && (mo2646getDeclarationDescriptor2 instanceof TypeParameterDescriptor)) {
            return INSTANCE.areTypeParametersEquivalent((TypeParameterDescriptor) mo2646getDeclarationDescriptor, (TypeParameterDescriptor) mo2646getDeclarationDescriptor2, z, new Function2<DeclarationDescriptor, DeclarationDescriptor, Boolean>() { // from class: kotlin.reflect.jvm.internal.impl.resolve.DescriptorEquivalenceForOverrides$areCallableDescriptorsEquivalent$overridingUtil$1$1
