...
public final class InlineClassManglingRulesKt {
    ...
    public static final boolean isInlineClassThatRequiresMangling(KotlinType kotlinType) {
        ...
        return mo2646getDeclarationDescriptor != null && isInlineClassThatRequiresMangling(mo2646getDeclarationDescriptor);
    }
    ...
    private static final boolean isTypeParameterWithUpperBoundThatRequiresMangling(KotlinType kotlinType) {
        ClassifierDescriptor mo2646getDeclarationDescriptor = kotlinType.getConstructor().mo2646getDeclarationDescriptor();
        TypeParameterDescriptor typeParameterDescriptor = mo2646getDeclarationDescriptor instanceof TypeParameterDescriptor ? (TypeParameterDescriptor) mo2646getDeclarationDescriptor : null;
