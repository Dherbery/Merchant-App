...
public final class DescriptorUtilsKt {
    ...
    public static final ClassDescriptor resolveTopLevelClass(ModuleDescriptor moduleDescriptor, FqName topLevelClassFqName, LookupLocation location) {
        ...
        ClassifierDescriptor contributedClassifier = memberScope.mo2648getContributedClassifier(shortName, location);
    ...
    public static final ClassDescriptor getSuperClassNotAny(ClassDescriptor classDescriptor) {
        ...
        for (KotlinType kotlinType : classDescriptor.getDefaultType().getConstructor().mo2647getSupertypes()) {
            if (!KotlinBuiltIns.isAnyOrNullableAny(kotlinType)) {
                ClassifierDescriptor mo2646getDeclarationDescriptor = kotlinType.getConstructor().mo2646getDeclarationDescriptor();
                if (DescriptorUtils.isClassOrEnumClass(mo2646getDeclarationDescriptor)) {
    ...
    public static final ClassDescriptor getAnnotationClass(AnnotationDescriptor annotationDescriptor) {
        ...
        ClassifierDescriptor mo2646getDeclarationDescriptor = annotationDescriptor.getType().getConstructor().mo2646getDeclarationDescriptor();
