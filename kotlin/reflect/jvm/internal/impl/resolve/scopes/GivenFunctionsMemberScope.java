...
public abstract class GivenFunctionsMemberScope extends MemberScopeImpl {
    ...
    public final List<DeclarationDescriptor> createFakeOverrides(List<? extends FunctionDescriptor> list) {
        ...
        Collection<KotlinType> mo2647getSupertypes = this.containingClass.getTypeConstructor().mo2647getSupertypes();
        Intrinsics.checkNotNullExpressionValue(mo2647getSupertypes, "containingClass.typeConstructor.supertypes");
