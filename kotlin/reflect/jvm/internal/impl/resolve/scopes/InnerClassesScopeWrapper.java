...
public final class InnerClassesScopeWrapper extends MemberScopeImpl {
    ...
    public ClassifierDescriptor mo2648getContributedClassifier(Name name, LookupLocation location) {
        ...
        ClassifierDescriptor contributedClassifier = this.workerScope.mo2648getContributedClassifier(name, location);
    ...
    public void mo2652recordLookup(Name name, LookupLocation location) {
        Intrinsics.checkNotNullParameter(name, "name");
        Intrinsics.checkNotNullParameter(location, "location");
        this.workerScope.mo2652recordLookup(name, location);
    }
