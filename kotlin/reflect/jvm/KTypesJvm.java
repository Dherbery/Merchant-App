    ...
    public static final KClass<?> getJvmErasure(KClassifier kClassifier) {
        ...
        if (kClassifier instanceof KTypeParameter) {
            ...
            while (true) {
                ...
                ClassifierDescriptor mo2646getDeclarationDescriptor = ((KTypeImpl) kType).getType().getConstructor().mo2646getDeclarationDescriptor();
                classDescriptor = mo2646getDeclarationDescriptor instanceof ClassDescriptor ? (ClassDescriptor) mo2646getDeclarationDescriptor : null;
