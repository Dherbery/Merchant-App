...
public final class UMathKt {
    ...
    private static final int m2578minJ1ME1BU(int i, int i2) {
        return UComparisonsKt.m2527minOfJ1ME1BU(i, i2);
    }

    /* renamed from: min-eb3DHEI, reason: not valid java name */
    private static final long m2579mineb3DHEI(long j, long j2) {
        return UComparisonsKt.m2535minOfeb3DHEI(j, j2);
    }

    /* renamed from: max-J1ME1BU, reason: not valid java name */
    private static final int m2576maxJ1ME1BU(int i, int i2) {
        return UComparisonsKt.m2515maxOfJ1ME1BU(i, i2);
    }

    /* renamed from: max-eb3DHEI, reason: not valid java name */
    private static final long m2577maxeb3DHEI(long j, long j2) {
        return UComparisonsKt.m2523maxOfeb3DHEI(j, j2);
    }
}
