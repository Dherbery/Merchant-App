...
public final class Result<T> implements Serializable {
    ...
    public static final /* synthetic */ Result m1317boximpl(Object obj) {
        return new Result(obj);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static <T> Object m1318constructorimpl(Object obj) {
        return obj;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m1319equalsimpl(Object obj, Object obj2) {
        return (obj2 instanceof Result) && Intrinsics.areEqual(obj, ((Result) obj2).getValue());
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m1320equalsimpl0(Object obj, Object obj2) {
    ...
    public static int m1323hashCodeimpl(Object obj) {
        if (obj == null) {
            return 0;
        }
        return obj.hashCode();
    ...
    public static final boolean m1325isSuccessimpl(Object obj) {
        return !(obj instanceof Failure);
    }

    /* renamed from: isFailure-impl, reason: not valid java name */
    public static final boolean m1324isFailureimpl(Object obj) {
        return obj instanceof Failure;
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* renamed from: getOrNull-impl, reason: not valid java name */
    private static final T m1322getOrNullimpl(Object obj) {
        if (m1324isFailureimpl(obj)) {
            return null;
        }
        return obj;
    }
    ...
    public static final Throwable m1321exceptionOrNullimpl(Object obj) {
    ...
    public String toString() {
        return m1326toStringimpl(this.value);
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m1326toStringimpl(Object obj) {
        if (obj instanceof Failure) {
    ...
    public static final class Companion {
        ...
        private final <T> Object success(T value) {
            return Result.m1318constructorimpl(value);
        }

        private final <T> Object failure(Throwable exception) {
            Intrinsics.checkNotNullParameter(exception, "exception");
            return Result.m1318constructorimpl(ResultKt.createFailure(exception));
        }
    }
