...
final class UIntProgressionIterator implements Iterator<UInt>, KMappedMarker {
    ...
    */
    private UIntProgressionIterator(int r4, int r5, int r6) {
        ...
        L18:
            r3.hasNext = r0
            int r6 = kotlin.UInt.m1416constructorimpl(r6)
            r3.step = r6
    ...
    public /* bridge */ /* synthetic */ UInt next() {
        return UInt.m1410boximpl(m2592nextpVg5ArA());
    }
    ...
    public int m2592nextpVg5ArA() {
        ...
        if (i == this.finalElement) {
            ...
            this.next = UInt.m1416constructorimpl(this.step + i);
        }
        return i;
    }
}
