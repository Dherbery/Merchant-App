...
public class b {
    ...
    public static final String ad = "false";
    public static final String ae = "2.0";
    public static final String af = "1.0";
    public static final String ag = "MM/dd/yyyy HH:mm:ss";
    public static final String ah = "stringToSign";
    public static final String ai = "signature";
    public static final String aj = "IapReceiptVerificationFailed";
    public static final String ak = "maxVersion";
    public static final String al = "notifyListenerResult";
    public static final String am = "newCursor";
    public static final String an = "debug.amazon.sandboxmode";
    public static final String ao = "debug";
    public static final String ap = "/system/bin/getprop";
    public static final String aq = "android.os.SystemProperties";
    public static final String ar = "get";
