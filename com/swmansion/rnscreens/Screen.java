    ...
    public final void setScreenOrientation(String screenOrientation) {
        ...
        switch (screenOrientation.hashCode()) {
            case -1894896954:
                ...
                break;
            case 96673:
                if (screenOrientation.equals(TtmlNode.COMBINE_ALL)) {
                    i = 10;
                    break;
                }
                i = -1;
