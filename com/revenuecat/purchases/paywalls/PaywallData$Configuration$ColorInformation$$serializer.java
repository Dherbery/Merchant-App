...
public final class PaywallData$Configuration$ColorInformation$$serializer implements GeneratedSerializer<PaywallData.Configuration.ColorInformation> {
    ...
    public PaywallData.Configuration.ColorInformation deserialize(Decoder decoder) {
        ...
        if (beginStructure.decodeSequentially()) {
            obj = beginStructure.decodeSerializableElement(descriptor2, 0, PaywallData$Configuration$Colors$$serializer.INSTANCE, null);
            obj2 = beginStructure.decodeNullableSerializableElement(descriptor2, 1, PaywallData$Configuration$Colors$$serializer.INSTANCE, null);
            i = 3;
        } else {
            boolean z = true;
            int i2 = 0;
            ...
            while (z) {
                ...
                if (decodeElementIndex == -1) {
                    ...
                    obj = beginStructure.decodeSerializableElement(descriptor2, 0, PaywallData$Configuration$Colors$$serializer.INSTANCE, obj);
                    i2 |= 1;
                } else {
                    if (decodeElementIndex != 1) {
    ...
    public void serialize(Encoder encoder, PaywallData.Configuration.ColorInformation value) {
        ...
        PaywallData.Configuration.ColorInformation.write$Self(value, beginStructure, descriptor2);
        beginStructure.endStructure(descriptor2);
    }
