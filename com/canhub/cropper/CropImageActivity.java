...
public class CropImageActivity extends AppCompatActivity implements CropImageView.OnSetImageUriCompleteListener, CropImageView.OnCropImageCompleteListener {
    ...
    public CropImageActivity() {
        ActivityResultLauncher<String> registerForActivityResult = registerForActivityResult(new ActivityResultContracts.GetContent(), new ActivityResultCallback() { // from class: com.canhub.cropper.CropImageActivity$$ExternalSyntheticLambda1
            ...
            public final void onActivityResult(Object obj) {
                CropImageActivity.m298pickImageGallery$lambda0(CropImageActivity.this, (Uri) obj);
            }
        });
        ...
        ActivityResultLauncher<Uri> registerForActivityResult2 = registerForActivityResult(new ActivityResultContracts.TakePicture(), new ActivityResultCallback() { // from class: com.canhub.cropper.CropImageActivity$$ExternalSyntheticLambda2
            @Override // androidx.activity.result.ActivityResultCallback
            public final void onActivityResult(Object obj) {
                CropImageActivity.m300takePicture$lambda1(CropImageActivity.this, (Boolean) obj);
            }
        });
    ...
    public static final void m298pickImageGallery$lambda0(CropImageActivity this$0, Uri uri) {
    ...
    public static final void m300takePicture$lambda1(CropImageActivity this$0, Boolean it) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
    ...
    public void showImageSourceDialog(final Function1<? super Source, Unit> openSource) {
        ...
        new AlertDialog.Builder(this).setCancelable(false).setTitle(R.string.pick_image_chooser_title).setItems(new String[]{getString(R.string.pick_image_camera), getString(R.string.pick_image_gallery)}, new DialogInterface.OnClickListener() { // from class: com.canhub.cropper.CropImageActivity$$ExternalSyntheticLambda0
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i) {
                CropImageActivity.m299showImageSourceDialog$lambda10(Function1.this, dialogInterface, i);
            }
        }).show();
    }
    ...
    public static final void m299showImageSourceDialog$lambda10(Function1 openSource, DialogInterface dialogInterface, int i) {
        Intrinsics.checkNotNullParameter(openSource, "$openSource");
