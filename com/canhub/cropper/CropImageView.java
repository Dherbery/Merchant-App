    ...
    */
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (bitmap != null) {
            ...
            int onMeasureSpec22 = companion2.getOnMeasureSpec(mode2, size2, i);
