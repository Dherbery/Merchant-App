...
public class RNCWebChromeClient extends WebChromeClient implements LifecycleEventListener {
    ...
    public void onGeolocationPermissionsShowPrompt(String str, GeolocationPermissions.Callback callback) {
        if (ContextCompat.checkSelfPermission(this.mWebView.getThemedReactContext(), LocationConstants.ANDROID_FINE_LOCATION_PERMISSION_STRING) != 0) {
            this.geolocationPermissionCallback = callback;
            this.geolocationPermissionOrigin = str;
            requestPermissions(Collections.singletonList(LocationConstants.ANDROID_FINE_LOCATION_PERMISSION_STRING));
            return;
        }
    ...
    public /* synthetic */ boolean lambda$new$0(int i, String[] strArr, int[] iArr) {
        ...
        for (int i2 = 0; i2 < strArr.length; i2++) {
            ...
            if (str2.equals(LocationConstants.ANDROID_FINE_LOCATION_PERMISSION_STRING) && (callback = this.geolocationPermissionCallback) != null && (str = this.geolocationPermissionOrigin) != null) {
                if (z2) {
                    callback.invoke(str, true, false);
                } else {
