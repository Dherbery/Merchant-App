...
public class PriorityNetworkFetcher<FETCH_STATE extends FetchState> implements NetworkFetcher<PriorityFetchState<FETCH_STATE>> {
    ...
    public static boolean shouldRetry(Throwable th, int i, int i2, int i3, boolean z, boolean z2, boolean z3, Priority priority) {
        ...
        return (z6 && message.contains("Canceled")) || (z6 && message.contains("unexpected end of stream on null")) || (((th instanceof SocketException) && message.contains("Socket closed")) || (z5 && (th instanceof InterruptedIOException) && message.contains(ClientComponent.NamedSchedulers.TIMEOUT)));
    }
}
