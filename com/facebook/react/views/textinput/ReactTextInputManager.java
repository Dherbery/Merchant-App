    ...
    public void setCursorColor(ReactEditText reactEditText, Integer num) {
        ...
        if (Build.VERSION.SDK_INT >= 29) {
            ...
            if (textCursorDrawable != null) {
                ReactTextView$$ExternalSyntheticApiModelOutline0.m664m();
                int intValue = num.intValue();
                blendMode = BlendMode.SRC_IN;
                textCursorDrawable.setColorFilter(ReactTextView$$ExternalSyntheticApiModelOutline0.m(intValue, blendMode));
