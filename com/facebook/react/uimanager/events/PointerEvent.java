...
public class PointerEvent extends Event<PointerEvent> {
    ...
    private WritableMap createW3CPointerEvent(int i) {
        ...
        createMap.putBoolean(ServiceToJsObjectConverter.Metadata.IS_PRIMARY, !isClickEvent() && (this.mEventState.supportsHover(pointerId) || pointerId == this.mEventState.mPrimaryPointerId));
