...
public class AndroidInfoModule extends NativePlatformConstantsAndroidSpec implements TurboModule {
    ...
    public Map<String, Object> getTypedExportedConstants() {
        ...
        hashMap.put("isTesting", Boolean.valueOf(b.ac.equals(System.getProperty(IS_TESTING)) || isRunningScreenshotTest().booleanValue()));
        String property = System.getProperty(IS_DISABLE_ANIMATIONS);
        if (property != null) {
            hashMap.put("isDisableAnimations", Boolean.valueOf(b.ac.equals(property)));
        }
