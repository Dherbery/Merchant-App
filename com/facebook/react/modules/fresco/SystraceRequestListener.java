...
public class SystraceRequestListener extends BaseRequestListener {
    ...
    public void onProducerStart(String str, String str2) {
        if (Systrace.isTracing(0L)) {
            Pair<Integer, String> create = Pair.create(Integer.valueOf(this.mCurrentID), "FRESCO_PRODUCER_" + str2.replace(AbstractJsonLexerKt.COLON, '_'));
    ...
    public void onRequestStart(ImageRequest imageRequest, Object obj, String str, boolean z) {
        if (Systrace.isTracing(0L)) {
            Pair<Integer, String> create = Pair.create(Integer.valueOf(this.mCurrentID), "FRESCO_REQUEST_" + imageRequest.getSourceUri().toString().replace(AbstractJsonLexerKt.COLON, '_'));
            Systrace.beginAsyncSection(0L, (String) create.second, this.mCurrentID);
