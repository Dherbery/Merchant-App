...
public class NumberFormat {
    ...
    private void setNumberFormatUnitOptions(Map<String, Object> map) throws JSRangeErrorException {
        this.mResolvedStyle = (IPlatformNumberFormatter.Style) OptionHelpers.searchEnum(IPlatformNumberFormatter.Style.class, JSObjects.getJavaString(OptionHelpers.GetOption(map, TtmlNode.TAG_STYLE, OptionHelpers.OptionType.STRING, new String[]{"decimal", "percent", b.a, "unit"}, "decimal")));
        Object GetOption = OptionHelpers.GetOption(map, b.a, OptionHelpers.OptionType.STRING, JSObjects.Undefined(), JSObjects.Undefined());
    ...
    public Map<String, Object> resolvedOptions() throws JSRangeErrorException {
        ...
        if (this.mResolvedStyle == IPlatformNumberFormatter.Style.CURRENCY) {
            linkedHashMap.put(b.a, this.mResolvedCurrency);
