...
public class PlatformNumberFormatterICU implements IPlatformNumberFormatter {
    ...
    public PlatformNumberFormatterICU setCurrency(String str, IPlatformNumberFormatter.CurrencyDisplay currencyDisplay) throws JSRangeErrorException {
        ...
        if (this.mStyle == IPlatformNumberFormatter.Style.CURRENCY) {
            ...
            if (PlatformCollatorICU$$ExternalSyntheticApiModelOutline0.m327m((Object) this.mNumberFormat)) {
                DecimalFormat m = PlatformCollatorICU$$ExternalSyntheticApiModelOutline0.m((Object) this.mNumberFormat);
    ...
    public PlatformNumberFormatterICU setSignificantDigits(IPlatformNumberFormatter.RoundingType roundingType, int i, int i2) throws JSRangeErrorException {
        ...
        if (PlatformCollatorICU$$ExternalSyntheticApiModelOutline0.m327m((Object) this.mNumberFormat) && roundingType == IPlatformNumberFormatter.RoundingType.SIGNIFICANT_DIGITS) {
            DecimalFormat m = PlatformCollatorICU$$ExternalSyntheticApiModelOutline0.m((Object) this.mNumberFormat);
            if (i >= 0) {
    ...
    public PlatformNumberFormatterICU setFractionDigits(IPlatformNumberFormatter.RoundingType roundingType, int i, int i2) {
        if (roundingType == IPlatformNumberFormatter.RoundingType.FRACTION_DIGITS) {
            ...
            if (PlatformCollatorICU$$ExternalSyntheticApiModelOutline0.m327m((Object) this.mNumberFormat)) {
                PlatformCollatorICU$$ExternalSyntheticApiModelOutline0.m((Object) this.mNumberFormat).setSignificantDigitsUsed(false);
            }
        }
        return this;
    }
    ...
    private static MeasureUnit parseUnit(String str) throws JSRangeErrorException {
        ...
        while (it.hasNext()) {
            MeasureUnit m317m = PlatformCollatorICU$$ExternalSyntheticApiModelOutline0.m317m(it.next());
            subtype = m317m.getSubtype();
            if (!subtype.equals(str)) {
                subtype2 = m317m.getSubtype();
    ...
    public String format(double d) {
        ...
        try {
            try {
                if (PlatformCollatorICU$$ExternalSyntheticApiModelOutline0.m$1(this.mFinalFormat) && this.mMeasureUnit != null) {
                    Format format3 = this.mFinalFormat;
                    PlatformCollatorICU$$ExternalSyntheticApiModelOutline0.m324m();
                    return format3.format(PlatformCollatorICU$$ExternalSyntheticApiModelOutline0.m(Double.valueOf(d), this.mMeasureUnit));
                }
    ...
    public String fieldToString(AttributedCharacterIterator.Attribute attribute, double d) {
        ...
        return attribute == field11 ? b.a : attribute.toString().equals("android.icu.text.NumberFormat$Field(compact)") ? "compact" : "literal";
    }
        ...
        try {
            try {
                if (PlatformCollatorICU$$ExternalSyntheticApiModelOutline0.m$1(this.mFinalFormat) && this.mMeasureUnit != null) {
                    ...
                    PlatformCollatorICU$$ExternalSyntheticApiModelOutline0.m324m();
                    return format.formatToCharacterIterator(PlatformCollatorICU$$ExternalSyntheticApiModelOutline0.m(Double.valueOf(d), this.mMeasureUnit));
                }
    ...
    public PlatformNumberFormatterICU configure(ILocaleObject<?> iLocaleObject, String str, IPlatformNumberFormatter.Style style, IPlatformNumberFormatter.CurrencySign currencySign, IPlatformNumberFormatter.Notation notation, IPlatformNumberFormatter.CompactDisplay compactDisplay) throws JSRangeErrorException {
        ...
        if (notation == IPlatformNumberFormatter.Notation.COMPACT && (style == IPlatformNumberFormatter.Style.DECIMAL || style == IPlatformNumberFormatter.Style.UNIT)) {
            ...
            compactDecimalFormat = CompactDecimalFormat.getInstance(WebViewCompat$$ExternalSyntheticApiModelOutline8.m215m(iLocaleObject.getLocale()), compactStyle);
            initialize(compactDecimalFormat, iLocaleObject, style);
        } else {
            numberFormat = android.icu.text.NumberFormat.getInstance(WebViewCompat$$ExternalSyntheticApiModelOutline8.m215m(iLocaleObject.getLocale()), style.getInitialNumberFormatStyle(notation, currencySign));
