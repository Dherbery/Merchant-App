...
public class PlatformCollatorICU implements IPlatformCollator {
    ...
    public IPlatformCollator configure(ILocaleObject<?> iLocaleObject) throws JSRangeErrorException {
        ...
        RuleBasedCollator m313m = PlatformCollatorICU$$ExternalSyntheticApiModelOutline0.m313m((Object) ruleBasedCollator);
        this.mCollator = m313m;
        m313m.setDecomposition(17);
        return this;
    }
