...
public class PlatformDateTimeFormatterICU implements IPlatformDateTimeFormatter {
    ...
    public String getDefaultCalendarName(ILocaleObject<?> iLocaleObject) throws JSRangeErrorException {
        ...
        Calendar calendar;
        String type;
        dateInstance = DateFormat.getDateInstance(3, WebViewCompat$$ExternalSyntheticApiModelOutline8.m215m(iLocaleObject.getLocale()));
    ...
    public IPlatformDateTimeFormatter.HourCycle getDefaultHourCycle(ILocaleObject<?> iLocaleObject) throws JSRangeErrorException {
        ...
        try {
            timeInstance = DateFormat.getTimeInstance(0, WebViewCompat$$ExternalSyntheticApiModelOutline8.m215m(iLocaleObject.getLocale()));
            pattern = PlatformCollatorICU$$ExternalSyntheticApiModelOutline0.m314m((Object) timeInstance).toPattern();
    ...
    public String getDefaultTimeZone(ILocaleObject<?> iLocaleObject) throws JSRangeErrorException {
        ...
        TimeZone timeZone;
        String id;
        calendar = Calendar.getInstance(WebViewCompat$$ExternalSyntheticApiModelOutline8.m215m(iLocaleObject.getLocale()));
    ...
    public String getDefaultNumberingSystem(ILocaleObject<?> iLocaleObject) throws JSRangeErrorException {
        ...
        String name;
        numberingSystem = NumberingSystem.getInstance(WebViewCompat$$ExternalSyntheticApiModelOutline8.m215m(iLocaleObject.getLocale()));
    ...
    private static String getPatternForStyle(ILocaleObject<?> iLocaleObject, IPlatformDateTimeFormatter.DateStyle dateStyle, IPlatformDateTimeFormatter.TimeStyle timeStyle) throws JSRangeErrorException {
        ...
        if (dateStyle == IPlatformDateTimeFormatter.DateStyle.UNDEFINED) {
            timeInstance = DateFormat.getTimeInstance(toICUTimeStyle(timeStyle), WebViewCompat$$ExternalSyntheticApiModelOutline8.m215m(iLocaleObject.getLocale()));
            localizedPattern3 = PlatformCollatorICU$$ExternalSyntheticApiModelOutline0.m314m((Object) timeInstance).toLocalizedPattern();
            return localizedPattern3;
        }
        if (timeStyle == IPlatformDateTimeFormatter.TimeStyle.UNDEFINED) {
            dateInstance = DateFormat.getDateInstance(toICUDateStyle(dateStyle), WebViewCompat$$ExternalSyntheticApiModelOutline8.m215m(iLocaleObject.getLocale()));
            localizedPattern2 = PlatformCollatorICU$$ExternalSyntheticApiModelOutline0.m314m((Object) dateInstance).toLocalizedPattern();
            return localizedPattern2;
        }
        dateTimeInstance = DateFormat.getDateTimeInstance(toICUDateStyle(dateStyle), toICUTimeStyle(timeStyle), WebViewCompat$$ExternalSyntheticApiModelOutline8.m215m(iLocaleObject.getLocale()));
        localizedPattern = PlatformCollatorICU$$ExternalSyntheticApiModelOutline0.m314m((Object) dateTimeInstance).toLocalizedPattern();
    ...
    public void configure(ILocaleObject<?> iLocaleObject, String str, String str2, IPlatformDateTimeFormatter.FormatMatcher formatMatcher, IPlatformDateTimeFormatter.WeekDay weekDay, IPlatformDateTimeFormatter.Era era, IPlatformDateTimeFormatter.Year year, IPlatformDateTimeFormatter.Month month, IPlatformDateTimeFormatter.Day day, IPlatformDateTimeFormatter.Hour hour, IPlatformDateTimeFormatter.Minute minute, IPlatformDateTimeFormatter.Second second, IPlatformDateTimeFormatter.TimeZoneName timeZoneName, IPlatformDateTimeFormatter.HourCycle hourCycle, Object obj, IPlatformDateTimeFormatter.DateStyle dateStyle, IPlatformDateTimeFormatter.TimeStyle timeStyle, Object obj2) throws JSRangeErrorException {
        ...
        if (str.isEmpty()) {
            ...
            calendar = Calendar.getInstance(WebViewCompat$$ExternalSyntheticApiModelOutline8.m215m(cloneObject.getLocale()));
        }
        if (!str2.isEmpty()) {
            try {
        ...
        if (calendar != null) {
            patternInstance2 = DateFormat.getPatternInstance(calendar, skeleton, WebViewCompat$$ExternalSyntheticApiModelOutline8.m215m(iLocaleObject.getLocale()));
            this.mDateFormat = patternInstance2;
        } else {
            patternInstance = DateFormat.getPatternInstance(skeleton, WebViewCompat$$ExternalSyntheticApiModelOutline8.m215m(iLocaleObject.getLocale()));
