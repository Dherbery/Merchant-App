...
public class MapModule extends ReactContextBaseJavaModule {
    ...
    public void enableLatestRenderer(final Promise promise) {
        final ReactApplicationContext reactApplicationContext = getReactApplicationContext();
        ((UIManagerModule) reactApplicationContext.getNativeModule(UIManagerModule.class)).addUIBlock(new UIBlock() { // from class: com.rnmaps.maps.MapModule.7
            @Override // com.facebook.react.uimanager.UIBlock
            public void execute(NativeViewHierarchyManager nativeViewHierarchyManager) {
                MapsInitializer.initialize(reactApplicationContext, MapsInitializer.Renderer.LATEST, new OnMapsSdkInitializedCallback() { // from class: com.rnmaps.maps.MapModule.7.1
