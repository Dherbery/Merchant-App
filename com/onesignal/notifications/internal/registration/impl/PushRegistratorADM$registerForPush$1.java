...
public final class PushRegistratorADM$registerForPush$1 extends ContinuationImpl {
    Object L$0;
    int label;
    ...
    public PushRegistratorADM$registerForPush$1(PushRegistratorADM pushRegistratorADM, Continuation<? super PushRegistratorADM$registerForPush$1> continuation) {
        super(continuation);
