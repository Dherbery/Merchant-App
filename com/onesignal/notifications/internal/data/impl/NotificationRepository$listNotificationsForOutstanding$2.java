...
public final class NotificationRepository$listNotificationsForOutstanding$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public NotificationRepository$listNotificationsForOutstanding$2(NotificationRepository notificationRepository, List<Integer> list, List<INotificationRepository.NotificationData> list2, Continuation<? super NotificationRepository$listNotificationsForOutstanding$2> continuation) {
