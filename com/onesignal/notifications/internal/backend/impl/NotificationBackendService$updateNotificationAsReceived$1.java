...
public final class NotificationBackendService$updateNotificationAsReceived$1 extends ContinuationImpl {
    int label;
    ...
    public NotificationBackendService$updateNotificationAsReceived$1(NotificationBackendService notificationBackendService, Continuation<? super NotificationBackendService$updateNotificationAsReceived$1> continuation) {
        super(continuation);
