...
public final class Dynamic extends TypeName {
    ...
    public /* bridge */ /* synthetic */ TypeName copy(boolean z, List list, Map map) {
        return (TypeName) m1170copy(z, (List<AnnotationSpec>) list, (Map<KClass<?>, ? extends Object>) map);
    }

    /* renamed from: copy, reason: collision with other method in class */
    public Void m1170copy(boolean nullable, List<AnnotationSpec> annotations, Map<KClass<?>, ? extends Object> tags) {
