...
public final class JvmAnnotations {
    ...
    public static final FunSpec.Builder m1175throws(FunSpec.Builder builder, TypeName... exceptionClasses) {
        Intrinsics.checkNotNullParameter(builder, "<this>");
        Intrinsics.checkNotNullParameter(exceptionClasses, "exceptionClasses");
        return m1174throws(builder, ArraysKt.toList(exceptionClasses));
    }

    /* renamed from: throws, reason: not valid java name */
    public static final FunSpec.Builder m1174throws(FunSpec.Builder builder, Iterable<? extends TypeName> exceptionClasses) {
        Intrinsics.checkNotNullParameter(builder, "<this>");
        Intrinsics.checkNotNullParameter(exceptionClasses, "exceptionClasses");
    ...
    public static final FunSpec.Builder m1173synchronized(FunSpec.Builder builder) {
        Intrinsics.checkNotNullParameter(builder, "<this>");
        if (!(!FunSpec.INSTANCE.isConstructor$kotlinpoet(builder.getName()))) {
    ...
    public static final FunSpec.Builder m1172strictfp(FunSpec.Builder builder) {
        Intrinsics.checkNotNullParameter(builder, "<this>");
    ...
    public static final PropertySpec.Builder m1178transient(PropertySpec.Builder builder) {
        Intrinsics.checkNotNullParameter(builder, "<this>");
        return builder.addAnnotation(Reflection.getOrCreateKotlinClass(Transient.class));
    }

    /* renamed from: volatile, reason: not valid java name */
    public static final PropertySpec.Builder m1179volatile(PropertySpec.Builder builder) {
        Intrinsics.checkNotNullParameter(builder, "<this>");
    ...
    /* renamed from: throws, reason: not valid java name */
    public static final FunSpec.Builder m1177throws(FunSpec.Builder builder, KClass<? extends Throwable>... exceptionClasses) {
        Intrinsics.checkNotNullParameter(builder, "<this>");
        Intrinsics.checkNotNullParameter(exceptionClasses, "exceptionClasses");
        ...
        return m1174throws(builder, arrayList);
    }

    /* renamed from: throws, reason: not valid java name */
    public static final FunSpec.Builder m1176throws(FunSpec.Builder builder, Type... exceptionClasses) {
        Intrinsics.checkNotNullParameter(builder, "<this>");
        Intrinsics.checkNotNullParameter(exceptionClasses, "exceptionClasses");
        ArrayList arrayList = new ArrayList(exceptionClasses.length);
