...
class RNSVGRenderableManager extends NativeSvgRenderableModuleSpec {
    ...
    public WritableMap getPointAtLength(Double d, ReadableMap readableMap) {
        ...
        try {
            ...
            pathMeasure.getPosTan(Math.max(0.0f, Math.min(((float) readableMap.getDouble(SessionDescription.ATTR_LENGTH)) * renderableViewByTag.mScale, pathMeasure.getLength())), fArr, fArr2);
