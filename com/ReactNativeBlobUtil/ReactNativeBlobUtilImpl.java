...
public class ReactNativeBlobUtilImpl {
    ...
    public void addCompleteDownload(ReadableMap readableMap, Promise promise) {
        ...
        String normalizePath = ReactNativeBlobUtilUtils.normalizePath(readableMap.getString(ReactNativeBlobUtilConst.RNFB_RESPONSE_PATH));
        if (normalizePath == null) {
            ...
            try {
                downloadManager.addCompletedDownload(readableMap.hasKey("title") ? readableMap.getString("title") : "", readableMap.hasKey(b.c) ? readableMap.getString(b.c) : "", true, readableMap.hasKey("mime") ? readableMap.getString("mime") : null, normalizePath, Long.valueOf(ReactNativeBlobUtilFS.statFile(normalizePath).getString("size")).longValue(), readableMap.hasKey("showNotification") && readableMap.getBoolean("showNotification"));
                promise.resolve(null);
            } catch (Exception e) {
                promise.reject("EUNSPECIFIED", e.getLocalizedMessage());
            }
