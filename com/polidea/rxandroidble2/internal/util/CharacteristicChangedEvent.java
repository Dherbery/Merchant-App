...
public class CharacteristicChangedEvent extends CharacteristicNotificationId {
    ...
    public String toString() {
        return "CharacteristicChangedEvent{UUID=" + ((UUID) this.first).toString() + ", instanceId=" + ((Integer) this.second).toString() + ", data=" + Arrays.toString(this.data) + AbstractJsonLexerKt.END_OBJ;
    }
}
