...
public abstract class EnhancedIntentService extends Service {
    ...
    public Task<Void> processIntent(final Intent intent) {
        ...
        this.executor.execute(new Runnable() { // from class: com.google.firebase.messaging.EnhancedIntentService$$ExternalSyntheticLambda0
            ...
            public final void run() {
                EnhancedIntentService.this.m920x624ce8b2(intent, taskCompletionSource);
            }
        });
    ...
    public /* synthetic */ void m920x624ce8b2(Intent intent, TaskCompletionSource taskCompletionSource) {
        try {
            handleIntent(intent);
        } finally {
    ...
    public final int onStartCommand(final Intent intent, int i, int i2) {
        ...
        processIntent.addOnCompleteListener(new AdIdManager$Api33Ext4Impl$$ExternalSyntheticLambda6(), new OnCompleteListener() { // from class: com.google.firebase.messaging.EnhancedIntentService$$ExternalSyntheticLambda1
            @Override // com.google.android.gms.tasks.OnCompleteListener
            public final void onComplete(Task task) {
                EnhancedIntentService.this.m919x83fa35aa(intent, task);
            }
        });
        return 3;
    }
    ...
    public /* synthetic */ void m919x83fa35aa(Intent intent, Task task) {
        finishTask(intent);
    }
