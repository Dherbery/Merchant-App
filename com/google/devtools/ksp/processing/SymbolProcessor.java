...
public interface SymbolProcessor {
    ...
    /* compiled from: SymbolProcessor.kt */
    /* renamed from: com.google.devtools.ksp.processing.SymbolProcessor$-CC, reason: invalid class name */
    /* loaded from: classes5.dex */
    public final /* synthetic */ class CC {
        public static void $default$finish(SymbolProcessor _this) {
        }

        public static void $default$onError(SymbolProcessor _this) {
        }
    }
    ...
    public static final class DefaultImpls {
        ...
        public static void finish(SymbolProcessor symbolProcessor) {
            CC.$default$finish(symbolProcessor);
        }

        @Deprecated
        public static void onError(SymbolProcessor symbolProcessor) {
            CC.$default$onError(symbolProcessor);
        }
    }
}
