...
public class KeyHandle extends AbstractSafeParcelable {
    ...
    public static KeyHandle parseFromJson(JSONObject jSONObject) throws JSONException {
        try {
            try {
                return new KeyHandle(Base64.decode(jSONObject.getString(SignResponseData.JSON_RESPONSE_DATA_KEY_HANDLE), 8), ProtocolVersion.fromString(jSONObject.has(Constants.AMP_PLAN_VERSION) ? jSONObject.getString(Constants.AMP_PLAN_VERSION) : null), jSONObject.has("transports") ? Transport.parseTransports(jSONObject.getJSONArray("transports")) : null);
    ...
    public final JSONObject zza() {
        ...
        try {
            ...
            if (protocolVersion != null) {
                jSONObject.put(Constants.AMP_PLAN_VERSION, protocolVersion.toString());
            }
            if (this.zzd != null) {
