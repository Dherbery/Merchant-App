...
public class RegisterRequest extends AbstractSafeParcelable {
    ...
    public static RegisterRequest parseFromJson(JSONObject jSONObject) throws JSONException {
        try {
            try {
                try {
                    return new RegisterRequest(ProtocolVersion.fromString(jSONObject.has(Constants.AMP_PLAN_VERSION) ? jSONObject.getString(Constants.AMP_PLAN_VERSION) : null), Base64.decode(jSONObject.getString(ClientData.KEY_CHALLENGE), 8), jSONObject.has("appId") ? jSONObject.getString("appId") : null);
    ...
    public JSONObject toJson() {
        ...
        try {
            jSONObject.put(Constants.AMP_PLAN_VERSION, this.zzb.toString());
