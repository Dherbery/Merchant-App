...
public final class DynamiteModule {
    ...
    public static DynamiteModule load(Context context, VersionPolicy versionPolicy, String str) throws LoadingException {
        ...
        try {
            ...
            Log.i("DynamiteModule", "Considering local module " + str + Constants.SUBS_ID_BASE_PLAN_ID_SEPARATOR + selectModule.localVersion + " and remote module " + str + Constants.SUBS_ID_BASE_PLAN_ID_SEPARATOR + selectModule.remoteVersion);
