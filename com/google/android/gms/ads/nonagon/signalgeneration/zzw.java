        ...
        try {
            try {
                ...
                try {
                    ...
                    String optString = jSONObject.optString(ProxyAmazonBillingActivity.EXTRAS_REQUEST_ID, "");
                    ...
                    if (((Boolean) zzba.zzc().zza(zzbgc.zzju)).booleanValue()) {
                        try {
                            str8 = jSONObject.getJSONObject("extras").getBoolean("accept_3p_cookie") ? IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE : SessionDescription.SUPPORTED_SDP_VERSION;
