...
public class InstanceID {
    ...
    public String getToken(String str, String str2, Bundle bundle) throws IOException {
        ...
        if (zzbu.get().booleanValue() && zze.contains(Constants.SUBS_ID_BASE_PLAN_ID_SEPARATOR) && !zze.startsWith(String.valueOf(getId()).concat(Constants.SUBS_ID_BASE_PLAN_ID_SEPARATOR))) {
