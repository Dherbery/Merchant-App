    ...
    public final void zzB(int i, List list, boolean z) throws IOException {
        ...
        if (!z) {
            while (i2 < list.size()) {
                ...
                zzeeVar.zzp(i, (intValue >> 31) ^ (intValue + intValue));
                i2++;
            }
            return;
        }
        ...
        for (int i4 = 0; i4 < list.size(); i4++) {
            ...
            i3 += zzee.zzx((intValue2 >> 31) ^ (intValue2 + intValue2));
        }
        this.zza.zzq(i3);
        while (i2 < list.size()) {
    ...
    public final void zzD(int i, List list, boolean z) throws IOException {
        ...
        if (!z) {
            while (i2 < list.size()) {
                ...
                zzeeVar.zzr(i, (longValue >> 63) ^ (longValue + longValue));
                i2++;
            }
            return;
        }
        ...
        for (int i4 = 0; i4 < list.size(); i4++) {
            ...
            i3 += zzee.zzy((longValue2 >> 63) ^ (longValue2 + longValue2));
        }
        this.zza.zzq(i3);
        while (i2 < list.size()) {
            zzee zzeeVar2 = this.zza;
