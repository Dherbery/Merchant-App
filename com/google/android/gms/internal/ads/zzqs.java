...
public final class zzqs {
    ...
    public final AudioTrack zza(zzk zzkVar, int i) throws zzpx {
        ...
        try {
            if (zzfy.zza >= 29) {
                offloadedPlayback = new AudioTrack.Builder().setAudioAttributes(zzkVar.zza().zza).setAudioFormat(zzfy.zzv(this.zze, this.zzf, this.zzg)).setTransferMode(1).setBufferSizeInBytes(this.zzh).setSessionId(i).setOffloadedPlayback(this.zzc == 1);
