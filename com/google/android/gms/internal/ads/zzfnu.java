...
public final class zzfnu {
    ...
    public final List zzd(zzfgy zzfgyVar, zzfgm zzfgmVar, boolean z, String str, String str2, List list) {
        ...
        while (it.hasNext()) {
            boolean z2 = true;
            String zzj = zzj(zzj(zzj((String) it.next(), "@gw_adlocid@", zzfgyVar.zza.zza.zzf), "@gw_adnetrefresh@", true != z ? SessionDescription.SUPPORTED_SDP_VERSION : IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE), "@gw_sdkver@", this.zzb);
            if (zzfgmVar != null) {
