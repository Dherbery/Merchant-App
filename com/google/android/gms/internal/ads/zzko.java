...
public final class zzko extends zzm implements zzjj {
    ...
    public final void zzak(boolean z, int i, int i2) {
        ...
        this.zzk.zzn(z2, i3);
        zzal(zzc, 0, i2, false, 5, C.TIME_UNSET, -1, false);
    }
    ...
    */
    ...
    public final void zzB(zzut zzutVar) {
        ...
        if (zzmdVar.zzo() || zzmdVar.zzc() >= 0) {
            ...
            zzly zzad = zzad(this.zzac, zzmdVar, zzac(zzmdVar, zzg, C.TIME_UNSET));
            int i3 = zzad.zze;
            if (zzg != -1 && i3 != 1) {
                i3 = 4;
    ...
    public final long zzl() {
        ...
        if (!zzx()) {
            zzcx zzn = zzn();
            return zzn.zzo() ? C.TIME_UNSET : zzfy.zzt(zzn.zze(zzd(), this.zza, 0L).zzo);
        }
        zzly zzlyVar = this.zzac;
        zzur zzurVar = zzlyVar.zzb;
