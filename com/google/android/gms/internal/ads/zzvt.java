...
public final class zzvt implements zzup, zzacx, zzzc, zzzh, zzwf {
        ...
        for (int i2 = 0; i2 < length; i2++) {
            ...
            if (zzagaVar != null) {
                if (zzg || this.zzu[i2].zzb) {
                    ...
                    if (zzbyVar == null) {
                        zzc2 = new zzby(C.TIME_UNSET, zzagaVar);
                    } else {
    ...
    private final void zzV(int i) {
        ...
        this.zzg.zzc(new zzun(1, zzcb.zzb(zzb2.zzm), zzb2, 0, null, zzfy.zzt(this.zzH), C.TIME_UNSET));
        zArr[i] = true;
    }
    ...
    public final /* bridge */ /* synthetic */ void zzK(zzzg zzzgVar, long j, long j2) {
        zzadu zzaduVar;
        if (this.zzA == C.TIME_UNSET && (zzaduVar = this.zzz) != null) {
    ...
    */
    ...
    public final /* synthetic */ void zzG(zzadu zzaduVar) {
        this.zzz = this.zzs == null ? zzaduVar : new zzadt(C.TIME_UNSET, 0L);
        if (zzaduVar.zza() == C.TIME_UNSET && this.zzA != C.TIME_UNSET) {
            this.zzz = new zzvn(this, this.zzz);
        }
        this.zzA = this.zzz.zza();
        boolean z = false;
        if (!this.zzG && zzaduVar.zza() == C.TIME_UNSET) {
            z = true;
        }
        this.zzB = z;
        this.zzC = true == z ? 7 : 1;
