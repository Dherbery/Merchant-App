...
public final class zzll {
        ...
        if (zzljVar.zzg) {
            ...
            if (zzi != -1) {
                ...
                if (zzcxVar.zze(i, this.zzb, 0L).zzp == zzi) {
                    Pair zzm = zzcxVar.zzm(this.zzb, this.zza, i, C.TIME_UNSET, Math.max(0L, zze));
                    if (zzm != null) {
                        obj = zzm.first;
                ...
                if (j3 != C.TIME_UNSET && zzljVar.zzc != C.TIME_UNSET) {
            ...
            if (zzurVar.zzb()) {
                ...
                if (this.zza.zza(i2) != -1) {
                    ...
                    if (j5 == C.TIME_UNSET) {
                        ...
                        Pair zzm2 = zzcxVar.zzm(zzcwVar, zzcuVar, zzcuVar.zzd, C.TIME_UNSET, Math.max(0L, zze));
                        if (zzm2 != null) {
    ...
    private final zzlj zzv(zzcx zzcxVar, Object obj, int i, int i2, long j, long j2) {
        ...
        return new zzlj(zzurVar, (zzh == C.TIME_UNSET || zzh > 0) ? 0L : Math.max(0L, (-1) + zzh), j, C.TIME_UNSET, zzh, false, false, false, false);
    }
    ...
    */
    ...
    public final boolean zzo() {
        ...
        if (zzliVar.zzf.zzi || !zzliVar.zzr() || this.zzj.zzf.zze == C.TIME_UNSET) {
            return false;
        }
        return this.zzk < 100;
    }
    ...
    public final boolean zzp(zzcx zzcxVar, long j, long j2) {
        ...
        for (zzli zzliVar2 = this.zzh; zzliVar2 != null; zzliVar2 = zzliVar2.zzg()) {
            ...
            if (j3 == C.TIME_UNSET || j3 == j4) {
                ...
                zzliVar2.zzq();
                long j5 = zzljVar.zze;
                long zze = j5 == C.TIME_UNSET ? Long.MAX_VALUE : j5 + zzliVar2.zze();
    ...
    public final zzli zzc(zzlj zzljVar) {
        zzli zzliVar = this.zzj;
        zzli zzd = zzkz.zzd(this.zzn.zza, zzljVar, zzliVar == null ? MediaPeriodQueue.INITIAL_RENDERER_POSITION_OFFSET_US : (zzliVar.zze() + zzliVar.zzf.zze) - zzljVar.zzb);
        zzli zzliVar2 = this.zzj;
        if (zzliVar2 != null) {
            zzliVar2.zzo(zzd);
        } else {
