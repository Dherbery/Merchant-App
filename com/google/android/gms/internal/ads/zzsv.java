...
public final class zzsv {
    ...
    */
    ...
    private final void zzj(String str) {
        zzff.zzb(com.google.android.exoplayer2.mediacodec.MediaCodecInfo.TAG, "NoSupport [" + str + "] [" + this.zza + ", " + this.zzb + "] [" + zzfy.zze + "]");
    }
    ...
    private final boolean zzl(zzam zzamVar, boolean z) {
        ...
        if (zza != null) {
            ...
            int i2 = 8;
            if (MimeTypes.VIDEO_DOLBY_VISION.equals(zzamVar.zzm)) {
            ...
            if (zzfy.zza <= 23 && MimeTypes.VIDEO_VP9.equals(this.zzb) && zzh.length == 0) {
            ...
            for (MediaCodecInfo.CodecProfileLevel codecProfileLevel2 : zzh) {
                i = (codecProfileLevel2.profile != intValue || (codecProfileLevel2.level < intValue2 && z) || (MimeTypes.VIDEO_H265.equals(this.zzb) && intValue == 2 && ("sailfish".equals(zzfy.zzb) || "marlin".equals(zzfy.zzb)))) ? i + 1 : 0;
            }
        ...
        if (i5 != -1) {
            ...
            if (codecCapabilities2 == null) {
                ...
                if (audioCapabilities2 == null) {
                    ...
                    if (maxInputChannelCount <= 1 && ((zzfy.zza < 26 || maxInputChannelCount <= 0) && !MimeTypes.AUDIO_MPEG.equals(str2) && !MimeTypes.AUDIO_AMR_NB.equals(str2) && !MimeTypes.AUDIO_AMR_WB.equals(str2) && !MimeTypes.AUDIO_AAC.equals(str2) && !MimeTypes.AUDIO_VORBIS.equals(str2) && !MimeTypes.AUDIO_OPUS.equals(str2) && !MimeTypes.AUDIO_RAW.equals(str2) && !MimeTypes.AUDIO_FLAC.equals(str2) && !MimeTypes.AUDIO_ALAW.equals(str2) && !MimeTypes.AUDIO_MLAW.equals(str2) && !MimeTypes.AUDIO_MSGSM.equals(str2))) {
                        if (MimeTypes.AUDIO_AC3.equals(str2)) {
                            i = 6;
                        } else {
                            i = MimeTypes.AUDIO_E_AC3.equals(str2) ? 16 : 30;
                        }
                        zzff.zzf(com.google.android.exoplayer2.mediacodec.MediaCodecInfo.TAG, "AssumedMaxChannelAdjustment: " + str + ", [" + maxInputChannelCount + " to " + i + "]");
    ...
    public final boolean zzg(int i, int i2, double d) {
        ...
        if (!zzk(videoCapabilities, i, i2, d)) {
            if (i < i2 && ((!"OMX.MTK.VIDEO.DECODER.HEVC".equals(this.zza) || !"mcv5a".equals(zzfy.zzb)) && zzk(videoCapabilities, i2, i, d))) {
                zzff.zzb(com.google.android.exoplayer2.mediacodec.MediaCodecInfo.TAG, "AssumedSupport [" + ("sizeAndRate.rotated, " + i + "x" + i2 + "@" + d) + "] [" + this.zza + ", " + this.zzb + "] [" + zzfy.zze + "]");
            } else {
