...
public final class zzfse implements zzfqu {
    ...
    public final synchronized void zzd(String str, MotionEvent motionEvent) throws zzfso {
        try {
            ...
            throw new zzfso(PlaybackException.ERROR_CODE_IO_FILE_NOT_FOUND, e);
        }
    }
    ...
    public final synchronized int zze() throws zzfso {
        try {
            ...
            throw new zzfso(PlaybackException.ERROR_CODE_IO_NO_PERMISSION, e);
        }
    ...
    public final synchronized void zzg() throws zzfso {
        try {
            ...
            throw new zzfso(PlaybackException.ERROR_CODE_IO_INVALID_HTTP_CONTENT_TYPE, e);
        }
    }
    ...
    public final synchronized boolean zzh() throws zzfso {
        try {
            ...
            throw new zzfso(PlaybackException.ERROR_CODE_IO_NETWORK_CONNECTION_FAILED, e);
        }
