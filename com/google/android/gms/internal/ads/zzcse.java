...
public final class zzcse {
    ...
    public final /* synthetic */ ListenableFuture zzc(final Uri.Builder builder, String str, InputEvent inputEvent, Integer num) throws Exception {
        if (num.intValue() == 1) {
            ...
            buildUpon.appendQueryParameter((String) com.google.android.gms.ads.internal.client.zzba.zzc().zza(zzbgc.zzjP), IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE);
