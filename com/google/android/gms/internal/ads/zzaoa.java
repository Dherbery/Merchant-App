...
final class zzaoa implements zzacf {
    ...
    public final zzace zza(zzacv zzacvVar, long j) throws IOException {
        ...
        long j4 = -1;
        while (zzfpVar.zzb() >= 188 && (zza2 = (zza = zzaom.zza(zzfpVar.zzM(), zzfpVar.zzd(), zze)) + TsExtractor.TS_PACKET_SIZE) <= zze) {
        ...
        return j3 != C.TIME_UNSET ? zzace.zzf(j3, zzf + j2) : zzace.zza;
    }
