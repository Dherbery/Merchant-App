    ...
    protected final boolean zzc(zzfp zzfpVar, long j, zzakb zzakbVar) throws IOException {
        ...
        if (this.zza == null) {
            ...
            if (zzaefVar2 == null) {
                ...
                this.zzd = new zzaef(zzj, zzm, zzj2, i6, i7, i8, (int) Math.pow(2.0d, zzm2 & 15), (int) Math.pow(2.0d, (zzm2 & PsExtractor.VIDEO_STREAM_MASK) >> 4), 1 == (zzfpVar.zzm() & 1), Arrays.copyOf(zzfpVar.zzM(), zzfpVar.zze()));
            } else {
            ...
            zzakVar.zzW(MimeTypes.AUDIO_VORBIS);
