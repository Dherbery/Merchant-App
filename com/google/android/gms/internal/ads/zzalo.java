...
final class zzalo {
    ...
    public static zzalo zzc(String str) {
        return new zzalo(null, str.replaceAll(IOUtils.LINE_SEPARATOR_WINDOWS, "\n").replaceAll(" *\n *", "\n").replaceAll("\n", MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR).replaceAll("[ \t\\x0B\f\r]+", MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR), C.TIME_UNSET, C.TIME_UNSET, null, null, "", null, null);
    }
    ...
    private final void zzm(long j, boolean z, String str, Map map) {
        ...
        if (!this.zzc || !z) {
            if (!TtmlNode.TAG_BR.equals(this.zza) || !z) {
                if (zzg(j)) {
                    for (Map.Entry entry : map.entrySet()) {
                        ...
                        zzq.getClass();
                        hashMap.put(str2, Integer.valueOf(zzq.length()));
                    }
                    ...
                    for (Map.Entry entry2 : map.entrySet()) {
                        ...
                        zzq2.getClass();
                        hashMap2.put(str3, Integer.valueOf(zzq2.length()));
                    }
                    return;
                }
                return;
