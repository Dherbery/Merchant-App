...
public final class zzacr {
    ...
    private static final int[] zzd = {64, 112, 128, 192, 224, 256, BitmapCounterConfig.DEFAULT_MAX_BITMAP_COUNT, 448, 512, 640, ViewUtils.EDGE_TO_EDGE_FLAGS, 896, 1024, 1152, 1280, 1536, 1920, 2048, 2304, 2560, 2688, 2816, 2823, 2944, 3072, 3840, 4096, 6144, 7680};
    ...
    public static zzam zza(byte[] bArr, String str, String str2, zzae zzaeVar) {
        ...
        zzakVar.zzK(str);
        zzakVar.zzW(MimeTypes.AUDIO_DTS);
        zzakVar.zzx(i5);
        zzakVar.zzy(i6);
        zzakVar.zzX(i4);
        zzakVar.zzE(null);
