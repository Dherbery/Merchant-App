...
public final class zzcsx implements zzbrq {
    ...
    public final JSONObject zzb(zzcta zzctaVar) throws JSONException {
        ...
        if (zzaypVar == null) {
            ...
            jSONObject3.put("windowVisibility", zzaypVar.zzb).put("isAttachedToWindow", z).put("viewBox", new JSONObject().put(ViewProps.TOP, zzaypVar.zzc.top).put(ViewProps.BOTTOM, zzaypVar.zzc.bottom).put("left", zzaypVar.zzc.left).put("right", zzaypVar.zzc.right)).put("adBox", new JSONObject().put(ViewProps.TOP, zzaypVar.zzd.top).put(ViewProps.BOTTOM, zzaypVar.zzd.bottom).put("left", zzaypVar.zzd.left).put("right", zzaypVar.zzd.right)).put("globalVisibleBox", new JSONObject().put(ViewProps.TOP, zzaypVar.zze.top).put(ViewProps.BOTTOM, zzaypVar.zze.bottom).put("left", zzaypVar.zze.left).put("right", zzaypVar.zze.right)).put("globalVisibleBoxVisible", zzaypVar.zzf).put("localVisibleBox", new JSONObject().put(ViewProps.TOP, zzaypVar.zzg.top).put(ViewProps.BOTTOM, zzaypVar.zzg.bottom).put("left", zzaypVar.zzg.left).put("right", zzaypVar.zzg.right)).put("localVisibleBoxVisible", zzaypVar.zzh).put("hitBox", new JSONObject().put(ViewProps.TOP, zzaypVar.zzi.top).put(ViewProps.BOTTOM, zzaypVar.zzi.bottom).put("left", zzaypVar.zzi.left).put("right", zzaypVar.zzi.right)).put("screenDensity", this.zza.getResources().getDisplayMetrics().density);
