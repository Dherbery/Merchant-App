...
public final class zzrj extends zzsz implements zzlh {
    ...
    protected final int zzZ(zztb zztbVar, zzam zzamVar) throws zzth {
        ...
        if ((!MimeTypes.AUDIO_RAW.equals(zzamVar.zzm) || this.zzd.zzz(zzamVar)) && this.zzd.zzz(zzfy.zzy(2, zzamVar.zzz, zzamVar.zzA))) {
    ...
    protected final zzsp zzae(zzsv zzsvVar, zzam zzamVar, MediaCrypto mediaCrypto, float f) {
        ...
        if (zzfy.zza <= 28 && MimeTypes.AUDIO_AC4.equals(zzamVar.zzm)) {
        ...
        this.zzi = (!MimeTypes.AUDIO_RAW.equals(zzsvVar.zzb) || MimeTypes.AUDIO_RAW.equals(zzamVar.zzm)) ? null : zzamVar;
    ...
    protected final void zzah(zzih zzihVar) {
        zzam zzamVar;
        if (zzfy.zza < 29 || (zzamVar = zzihVar.zza) == null || !Objects.equals(zzamVar.zzm, MimeTypes.AUDIO_OPUS) || !zzaG()) {
            return;
        }
    ...
    protected final void zzao() throws zziz {
        try {
            ...
            throw zzi(e, e.zzc, e.zzb, true != zzaG() ? PlaybackException.ERROR_CODE_AUDIO_TRACK_WRITE_FAILED : 5003);
        }
    }
    ...
    protected final boolean zzap(long j, long j2, zzsr zzsrVar, ByteBuffer byteBuffer, int i, int i2, int i3, long j3, boolean z, boolean z2, zzam zzamVar) throws zziz {
        ...
        try {
            ...
            throw zzi(e, this.zzh, e.zzb, PlaybackException.ERROR_CODE_AUDIO_TRACK_INIT_FAILED);
        } catch (zzqa e2) {
            if (zzaG()) {
                zzm();
            }
            throw zzi(e2, zzamVar, e2.zzb, PlaybackException.ERROR_CODE_AUDIO_TRACK_WRITE_FAILED);
        }
    }
