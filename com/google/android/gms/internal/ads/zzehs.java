...
public final class zzehs extends zzbwl {
    ...
    */
    ...
    private final void zzu(final Activity activity, final com.google.android.gms.ads.internal.overlay.zzm zzmVar) {
        ...
        if (NotificationManagerCompat.from(activity).areNotificationsEnabled()) {
            ...
            if (Build.VERSION.SDK_INT < 33) {
                ...
                zzJ.setTitle(zzr(R.string.notifications_permission_title, "Allow app to send you notifications?")).setPositiveButton(zzr(R.string.notifications_permission_confirm, "Allow"), new DialogInterface.OnClickListener() { // from class: com.google.android.gms.internal.ads.zzehl
    ...
    private final void zzv(Activity activity, final com.google.android.gms.ads.internal.overlay.zzm zzmVar) {
        ...
        timer.schedule(new zzehr(this, create, timer, zzmVar), C.DEFAULT_MAX_SEEK_TO_PREVIOUS_POSITION_MS);
    }
