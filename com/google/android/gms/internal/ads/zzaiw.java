...
public final class zzaiw {
    ...
    public static zzby zza(zzaim zzaimVar) {
        zzgc zzgcVar;
        zzain zzb = zzaimVar.zzb(Atom.TYPE_hdlr);
        zzain zzb2 = zzaimVar.zzb(Atom.TYPE_keys);
        zzain zzb3 = zzaimVar.zzb(Atom.TYPE_ilst);
    ...
    public static zzby zzb(zzain zzainVar) {
        ...
        zzfpVar.zzK(8);
        zzby zzbyVar = new zzby(C.TIME_UNSET, new zzbx[0]);
        while (zzfpVar.zzb() >= 8) {
            int zzd = zzfpVar.zzd();
            ...
            if (zzg2 == 1835365473) {
                ...
                while (true) {
                    ...
                    if (zzfpVar.zzg() != 1935766900) {
                        ...
                        if (zzn != -2147483647) {
                            zzbyVar2 = new zzby(C.TIME_UNSET, new zzahm(zzn, i2));
                        }
                    }
                }
                zzbyVar = zzbyVar.zzd(zzbyVar2);
    ...
    */
    ...
    private static zzby zzi(zzfp zzfpVar) {
        ...
        try {
            return new zzby(C.TIME_UNSET, new zzgf(Float.parseFloat(zzA.substring(0, max)), Float.parseFloat(zzA.substring(max, zzA.length() - 1))));
