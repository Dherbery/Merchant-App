...
final class zzajx {
    ...
    private final zzfp zzb = new zzfp(new byte[OggPageHeader.MAX_PAGE_PAYLOAD], 0);
    private int zzc = -1;
    private int zzd;
    private boolean zze;
    ...
    public final void zzd() {
        ...
        zzfpVar.zzI(Arrays.copyOf(zzfpVar.zzM(), Math.max(OggPageHeader.MAX_PAGE_PAYLOAD, zzfpVar.zze())), this.zzb.zze());
    }
