...
final class zzvf implements zzup, zzuo {
    ...
    public final long zzd() {
        ...
        for (zzup zzupVar : this.zzg) {
            ...
            } else if (j != C.TIME_UNSET && zzupVar.zze(j) != j) {
                throw new IllegalStateException("Unexpected child seekToUs result.");
            }
        }
        return j;
    ...
    public final long zzf(zzyi[] zzyiVarArr, boolean[] zArr, zzwh[] zzwhVarArr, boolean[] zArr2, long j) {
        ...
        while (true) {
            ...
            if (zzyiVar != null) {
                ...
                iArr2[i2] = Integer.parseInt(str.substring(0, str.indexOf(Constants.SUBS_ID_BASE_PLAN_ID_SEPARATOR)));
            } else {
                iArr2[i2] = -1;
            }
            i2++;
    ...
    public final void zzi(zzup zzupVar) {
        ...
        while (true) {
            ...
            if (i2 < zzupVarArr.length) {
                ...
                while (i5 < i4) {
                    zzcz zzb = zzh.zzb(i5);
                    zzcz zzc = zzb.zzc(i2 + Constants.SUBS_ID_BASE_PLAN_ID_SEPARATOR + zzb.zzc);
