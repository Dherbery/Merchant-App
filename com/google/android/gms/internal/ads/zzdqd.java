...
public final class zzdqd {
    ...
    private final ListenableFuture zzp(JSONObject jSONObject, zzfgm zzfgmVar, zzfgp zzfgpVar) {
        final ListenableFuture zzb = this.zzi.zzb(jSONObject.optString("base_url"), jSONObject.optString(InAppMessageContent.HTML), zzfgmVar, zzfgpVar, zzk(jSONObject.optInt("width", 0), jSONObject.optInt("height", 0)));
    ...
    public final /* synthetic */ ListenableFuture zzc(String str, Object obj) throws Exception {
        ...
        if (((Boolean) com.google.android.gms.ads.internal.client.zzba.zzc().zza(zzbgc.zzeX)).booleanValue()) {
            zza.loadData(Base64.encodeToString(str.getBytes(), 1), "text/html", ReactNativeBlobUtilConst.RNFB_RESPONSE_BASE64);
        } else {
    ...
    public final ListenableFuture zzh(JSONObject jSONObject, zzfgm zzfgmVar, zzfgp zzfgpVar) {
        ...
        if (zzg == null) {
            ...
            boolean z = false;
            if (((Boolean) com.google.android.gms.ads.internal.client.zzba.zzc().zza(zzbgc.zzjJ)).booleanValue() && optJSONObject.has(InAppMessageContent.HTML)) {
                z = true;
            }
            if (TextUtils.isEmpty(optString)) {
                if (!z) {
