...
public final class RtspClient implements Closeable {
    ...
    public final class MessageListener implements RtspMessageChannel.MessageListener {
        ...
        public void onRtspMessageReceived(final List<String> list) {
            this.messageHandler.post(new Runnable() { // from class: com.google.android.exoplayer2.source.rtsp.RtspClient$MessageListener$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    RtspClient.MessageListener.this.m770xbc9c051a(list);
                }
            });
        }
        ...
        public void m770xbc9c051a(List<String> list) {
        ...
        private void handleRtspResponse(List<String> list) {
            ...
            if (i != 200) {
                ...
                RtspClient.this.dispatchRtspError(new RtspMediaSource.RtspPlaybackException(RtspMessageUtil.toMethodString(i2) + MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR + parseResponse.status));
                return;
            }
            switch (i2) {
                case 1:
