...
public final class Score {
    ...
    public static List<Integer> score(Map<Integer, Integer> map) {
        ...
        for (Map.Entry entry2 : hashMap.entrySet()) {
            ...
            hashMap3.put(Integer.valueOf(intValue4), Double.valueOf((((Double) hashMap2.get(Integer.valueOf(intValue4))).doubleValue() * 100.0d * 0.7d) + ((cam16.getChroma() - TARGET_CHROMA) * (cam16.getChroma() < TARGET_CHROMA ? 0.1d : WEIGHT_CHROMA_ABOVE))));
        }
    ...
    private static List<Integer> filter(Map<Integer, Double> map, Map<Integer, Cam16> map2) {
        ...
        for (Map.Entry<Integer, Cam16> entry : map2.entrySet()) {
            ...
            if (value.getChroma() >= CUTOFF_CHROMA && ColorUtils.lstarFromArgb(intValue) >= CUTOFF_TONE && doubleValue >= 0.01d) {
