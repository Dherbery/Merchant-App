...
public class MaterialCheckBox extends AppCompatCheckBox {
    ...
    */
    ...
    public /* synthetic */ void m828xdf87d0bf() {
    ...
    public void setCheckedState(int i) {
        ...
        if (this.checkedState != i) {
            ...
            if (Build.VERSION.SDK_INT >= 26 && (m986m = Continue$with$1$$ExternalSyntheticApiModelOutline0.m986m(getContext().getSystemService(Continue$with$1$$ExternalSyntheticApiModelOutline0.m987m()))) != null) {
                m986m.notifyValueChanged(this);
            }
