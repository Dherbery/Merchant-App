    ...
    public class AnonymousClass2 extends IncidentEdgeSet<N> {
        ...
        public UnmodifiableIterator<EndpointPair<N>> iterator() {
            if (this.graph.isDirected()) {
                return Iterators.unmodifiableIterator(Iterators.concat(Iterators.transform(this.graph.predecessors((BaseGraph<N>) this.node).iterator(), new Function() { // from class: com.google.common.graph.AbstractBaseGraph$2$$ExternalSyntheticLambda0
                    ...
                    public final Object apply(Object obj) {
                        return AbstractBaseGraph.AnonymousClass2.this.m876lambda$iterator$0$comgooglecommongraphAbstractBaseGraph$2(obj);
                    }
                    ...
                    @Override // com.google.common.base.Function
                    public final Object apply(Object obj) {
                        return AbstractBaseGraph.AnonymousClass2.this.m877lambda$iterator$1$comgooglecommongraphAbstractBaseGraph$2(obj);
                    }
                })));
            }
            return Iterators.unmodifiableIterator(Iterators.transform(this.graph.adjacentNodes(this.node).iterator(), new Function() { // from class: com.google.common.graph.AbstractBaseGraph$2$$ExternalSyntheticLambda2
                @Override // com.google.common.base.Function
                public final Object apply(Object obj) {
                    return AbstractBaseGraph.AnonymousClass2.this.m878lambda$iterator$2$comgooglecommongraphAbstractBaseGraph$2(obj);
                }
            }));
        }
        ...
        public /* synthetic */ EndpointPair m876lambda$iterator$0$comgooglecommongraphAbstractBaseGraph$2(Object obj) {
        ...
        public /* synthetic */ EndpointPair m877lambda$iterator$1$comgooglecommongraphAbstractBaseGraph$2(Object obj) {
        ...
        public /* synthetic */ EndpointPair m878lambda$iterator$2$comgooglecommongraphAbstractBaseGraph$2(Object obj) {
