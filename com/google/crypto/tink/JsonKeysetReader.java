...
public final class JsonKeysetReader implements KeysetReader {
    ...
    private Keyset keysetFromJson(JsonObject json) throws IOException {
        ...
        JsonArray asJsonArray = json.getAsJsonArray(SubscriberAttributeKt.JSON_NAME_KEY);
    ...
    private static void validateKeyset(JsonObject json) {
        if (!json.has(SubscriberAttributeKt.JSON_NAME_KEY) || json.getAsJsonArray(SubscriberAttributeKt.JSON_NAME_KEY).size() == 0) {
