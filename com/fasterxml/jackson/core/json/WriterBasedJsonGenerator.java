...
public final class WriterBasedJsonGenerator extends JsonGeneratorImpl {
    ...
    public void writeBoolean(boolean z) throws IOException {
        ...
        if (z) {
            ...
            cArr[i3] = 'r';
            int i4 = i3 + 1;
            cArr[i4] = AbstractJsonLexerKt.UNICODE_ESC;
            i = i4 + 1;
            cArr[i] = 'e';
        } else {
            cArr[i2] = 'f';
    ...
    */
    ...
    private final void _writeNull() throws IOException {
        ...
        cArr[i] = 'n';
        int i2 = i + 1;
        cArr[i2] = AbstractJsonLexerKt.UNICODE_ESC;
        int i3 = i2 + 1;
        cArr[i3] = 'l';
        int i4 = i3 + 1;
        cArr[i4] = 'l';
    ...
    private void _prependOrWriteCharacterEscape(char c, int i) throws IOException, JsonGenerationException {
        ...
        if (i != -2) {
            ...
            if (i5 >= 6) {
                ...
                cArr3[i6] = '\\';
                int i7 = i6 + 1;
                cArr3[i7] = AbstractJsonLexerKt.UNICODE_ESC;
                if (c > 255) {
                    int i8 = (c >> '\b') & 255;
                    int i9 = i7 + 1;
    ...
    private int _prependOrWriteCharacterEscape(char[] cArr, int i, int i2, char c, int i3) throws IOException, JsonGenerationException {
        ...
        if (i > 5 && i < i2) {
            ...
            cArr[i7] = '\\';
            int i9 = i8 + 1;
            cArr[i8] = AbstractJsonLexerKt.UNICODE_ESC;
            if (c > 255) {
                int i10 = (c >> '\b') & 255;
                int i11 = i9 + 1;
