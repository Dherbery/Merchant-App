        ...
        */
        public Api33Ext5Impl(android.content.Context r2) {
            /*
                ...
                java.lang.Class r0 = androidx.webkit.WebViewCompat$$ExternalSyntheticApiModelOutline0.m200m()
                java.lang.Object r2 = r2.getSystemService(r0)
                java.lang.String r0 = "context.getSystemService…:class.java\n            )"
                kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(r2, r0)
                android.adservices.measurement.MeasurementManager r2 = androidx.webkit.WebViewCompat$$ExternalSyntheticApiModelOutline0.m188m(r2)
                r1.<init>(r2)
                return
            */
        ...
        public final android.adservices.measurement.DeletionRequest convertDeletionRequest(DeletionRequest request) {
            ...
            deletionMode = WebViewCompat$$ExternalSyntheticApiModelOutline0.m187m().setDeletionMode(request.getDeletionMode());
        ...
        public final android.adservices.measurement.WebSourceRegistrationRequest convertWebSourceRequest(WebSourceRegistrationRequest request) {
            ...
            webDestination = WebViewCompat$$ExternalSyntheticApiModelOutline0.m((List) convertWebSourceParams(request.getWebSourceParams()), request.getTopOriginUri()).setWebDestination(request.getWebDestination());
        ...
        private final List<android.adservices.measurement.WebSourceParams> convertWebSourceParams(List<WebSourceParams> request) {
            ...
            for (WebSourceParams webSourceParams : request) {
                WebViewCompat$$ExternalSyntheticApiModelOutline0.m205m$1();
                debugKeyAllowed = WebViewCompat$$ExternalSyntheticApiModelOutline0.m(webSourceParams.getRegistrationUri()).setDebugKeyAllowed(webSourceParams.getDebugKeyAllowed());
        ...
        public final android.adservices.measurement.WebTriggerRegistrationRequest convertWebTriggerRequest(WebTriggerRegistrationRequest request) {
            ...
            WebViewCompat$$ExternalSyntheticApiModelOutline0.m$3();
            build = WebViewCompat$$ExternalSyntheticApiModelOutline0.m190m((List) convertWebTriggerParams(request.getWebTriggerParams()), request.getDestination()).build();
            Intrinsics.checkNotNullExpressionValue(build, "Builder(\n               …\n                .build()");
            return build;
        }
        ...
        private final List<android.adservices.measurement.WebTriggerParams> convertWebTriggerParams(List<WebTriggerParams> request) {
            ...
            for (WebTriggerParams webTriggerParams : request) {
                WebViewCompat$$ExternalSyntheticApiModelOutline0.m202m();
                debugKeyAllowed = WebViewCompat$$ExternalSyntheticApiModelOutline0.m189m(webTriggerParams.getRegistrationUri()).setDebugKeyAllowed(webTriggerParams.getDebugKeyAllowed());
                build = debugKeyAllowed.build();
                Intrinsics.checkNotNullExpressionValue(build, "Builder(param.registrati…                 .build()");
                arrayList.add(build);
            }
