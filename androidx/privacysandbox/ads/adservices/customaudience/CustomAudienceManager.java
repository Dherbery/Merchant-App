        ...
        */
        public Api33Ext4Impl(android.content.Context r2) {
            /*
                ...
                java.lang.Class r0 = androidx.media.AudioFocusRequestCompat$$ExternalSyntheticApiModelOutline0.m168m$3()
                java.lang.Object r2 = r2.getSystemService(r0)
                java.lang.String r0 = "context.getSystemService…:class.java\n            )"
                kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(r2, r0)
                android.adservices.customaudience.CustomAudienceManager r2 = androidx.webkit.WebViewCompat$$ExternalSyntheticApiModelOutline0.m(r2)
                r1.<init>(r2)
                return
            */
        ...
        public final android.adservices.customaudience.JoinCustomAudienceRequest convertJoinRequest(JoinCustomAudienceRequest request) {
            ...
            customAudience = AudioFocusRequestCompat$$ExternalSyntheticApiModelOutline0.m150m().setCustomAudience(convertCustomAudience(request.getCustomAudience()));
        ...
        public final android.adservices.customaudience.LeaveCustomAudienceRequest convertLeaveRequest(LeaveCustomAudienceRequest request) {
            ...
            buyer = WebViewCompat$$ExternalSyntheticApiModelOutline0.m185m().setBuyer(convertAdTechIdentifier(request.getBuyer()));
        ...
        private final android.adservices.customaudience.CustomAudience convertCustomAudience(CustomAudience request) {
            ...
            activationTime = WebViewCompat$$ExternalSyntheticApiModelOutline0.m184m().setActivationTime(request.getActivationTime());
        ...
        private final List<AdData> convertAdData(List<androidx.privacysandbox.ads.adservices.common.AdData> input) {
            ...
            for (androidx.privacysandbox.ads.adservices.common.AdData adData : input) {
                metadata = WebViewCompat$$ExternalSyntheticApiModelOutline0.m().setMetadata(adData.getMetadata());
        ...
        private final android.adservices.customaudience.TrustedBiddingData convertTrustedSignals(TrustedBiddingData input) {
            ...
            trustedBiddingKeys = WebViewCompat$$ExternalSyntheticApiModelOutline0.m186m().setTrustedBiddingKeys(input.getTrustedBiddingKeys());
