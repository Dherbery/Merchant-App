            ...
            if ((i6 != 4 || this.mHasThumbnail) && (exifTag = sExifTagMapsForWriting[i6].get(str3)) != null) {
                if (str4 == null) {
                    ...
                    switch (i) {
                        ...
                        case 4:
                            i2 = i4;
                            String[] split2 = str4.split(f.a, -1);
                            ...
                            break;
                        case 5:
                            String[] split3 = str4.split(f.a, -1);
                        ...
                        case 9:
                            String[] split5 = str4.split(f.a, -1);
                            ...
                            break;
                        case 10:
                            String[] split6 = str4.split(f.a, -1);
                            ...
                            break;
                        case 12:
                            String[] split8 = str4.split(f.a, -1);
        ...
        if (str != null && NON_ZERO_TIME_PATTERN.matcher(str).matches()) {
            ...
            try {
                ...
                if (str3 != null) {
                    ...
                    if (("+".equals(substring) || "-".equals(substring)) && Constants.SUBS_ID_BASE_PLAN_ID_SEPARATOR.equals(str3.substring(3, 4)) && parseInt <= 14) {
