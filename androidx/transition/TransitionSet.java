...
public class TransitionSet extends Transition {
    ...
    public String toString(String str) {
        ...
        for (int i = 0; i < this.mTransitions.size(); i++) {
            ...
            sb.append("\n");
            sb.append(this.mTransitions.get(i).toString(str + FileSpecKt.DEFAULT_INDENT));
    ...
    @Override // androidx.transition.Transition
    /* renamed from: clone */
    public Transition mo182clone() {
        TransitionSet transitionSet = (TransitionSet) super.mo182clone();
        transitionSet.mTransitions = new ArrayList<>();
        int size = this.mTransitions.size();
        for (int i = 0; i < size; i++) {
            transitionSet.addTransitionInternal(this.mTransitions.get(i).mo182clone());
        }
