...
public class WebkitToCompatConverter {
    ...
    public ServiceWorkerWebSettings convertServiceWorkerSettings(InvocationHandler invocationHandler) {
        return WebViewCompat$$ExternalSyntheticApiModelOutline8.m220m(this.mImpl.convertServiceWorkerSettings(invocationHandler));
    }
    ...
    public SafeBrowsingResponse convertSafeBrowsingResponse(InvocationHandler invocationHandler) {
        return WebViewCompat$$ExternalSyntheticApiModelOutline8.m218m(this.mImpl.convertSafeBrowsingResponse(invocationHandler));
    }
