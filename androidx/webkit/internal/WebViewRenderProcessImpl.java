...
public class WebViewRenderProcessImpl extends WebViewRenderProcess {
    ...
    public boolean terminate() {
        ...
        if (webViewFeatureInternal.isSupportedByFramework()) {
            android.webkit.WebViewRenderProcess m223m = WebViewCompat$$ExternalSyntheticApiModelOutline8.m223m((Object) this.mFrameworkObject.get());
            if (m223m == null) {
                return false;
            }
            terminate = m223m.terminate();
            return terminate;
        }
