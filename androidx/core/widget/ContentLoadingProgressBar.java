...
public class ContentLoadingProgressBar extends ProgressBar {
    ...
    public /* synthetic */ void m139lambda$new$0$androidxcorewidgetContentLoadingProgressBar() {
    ...
    public /* synthetic */ void m140lambda$new$1$androidxcorewidgetContentLoadingProgressBar() {
    ...
    public ContentLoadingProgressBar(Context context, AttributeSet attributeSet) {
        ...
        this.mDelayedHide = new Runnable() { // from class: androidx.core.widget.ContentLoadingProgressBar$$ExternalSyntheticLambda2
            ...
            public final void run() {
                ContentLoadingProgressBar.this.m139lambda$new$0$androidxcorewidgetContentLoadingProgressBar();
            }
        };
        this.mDelayedShow = new Runnable() { // from class: androidx.core.widget.ContentLoadingProgressBar$$ExternalSyntheticLambda3
            @Override // java.lang.Runnable
            public final void run() {
                ContentLoadingProgressBar.this.m140lambda$new$1$androidxcorewidgetContentLoadingProgressBar();
            }
        };
    }
