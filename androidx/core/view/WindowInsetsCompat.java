...
public class WindowInsetsCompat {
    ...
    private static class BuilderImpl29 extends BuilderImpl {
        ...
        BuilderImpl29() {
            this.mPlatBuilder = HalfKt$$ExternalSyntheticApiModelOutline0.m114m();
        }

        BuilderImpl29(WindowInsetsCompat windowInsetsCompat) {
            super(windowInsetsCompat);
            WindowInsets.Builder m114m;
            WindowInsets windowInsets = windowInsetsCompat.toWindowInsets();
            if (windowInsets != null) {
                m114m = HalfKt$$ExternalSyntheticApiModelOutline0.m115m(windowInsets);
            } else {
                m114m = HalfKt$$ExternalSyntheticApiModelOutline0.m114m();
            }
            this.mPlatBuilder = m114m;
        }
