...
public class WorkerWrapper implements Runnable {
        ...
        try {
            ...
            this.mWorkerResultFuture.addListener(new Runnable() { // from class: androidx.work.impl.WorkerWrapper$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    WorkerWrapper.this.m238lambda$runWorker$0$androidxworkimplWorkerWrapper(future);
                }
    ...
    public /* synthetic */ void m238lambda$runWorker$0$androidxworkimplWorkerWrapper(ListenableFuture listenableFuture) {
