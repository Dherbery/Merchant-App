...
public final class ListenableFutureKt$await$2$1 implements Runnable {
    ...
    public final void run() {
        try {
            ...
            continuation.resumeWith(Result.m1318constructorimpl(this.$this_await.get()));
        } catch (Throwable th) {
            ...
            continuation2.resumeWith(Result.m1318constructorimpl(ResultKt.createFailure(cause)));
        }
    }
}
