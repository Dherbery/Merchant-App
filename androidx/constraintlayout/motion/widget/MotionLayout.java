...
public class MotionLayout extends ConstraintLayout implements NestedScrollingParent3 {
    ...
    public class Model {
        ...
        private void debugLayoutParam(String str, ConstraintLayout.LayoutParams layoutParams) {
            String concat = MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR.concat(layoutParams.startToStart != -1 ? "SS" : "__");
        ...
        private void debugLayout(String str, ConstraintWidgetContainer constraintWidgetContainer) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                Log.v(MotionLayout.TAG, str3 + FileSpecKt.DEFAULT_INDENT + name + MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR + constraintWidget + MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR + sb6);
            }
