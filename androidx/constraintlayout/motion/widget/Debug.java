...
public class Debug {
    public static void logStack(String str, String str2, int i) {
        ...
        for (int i2 = 1; i2 <= min; i2++) {
            ...
            String str4 = ".(" + stackTrace[i2].getFileName() + Constants.SUBS_ID_BASE_PLAN_ID_SEPARATOR + stackTrace[i2].getLineNumber() + ") " + stackTrace[i2].getMethodName();
        ...
        try {
            ...
            while (i < iArr.length) {
                ...
                try {
                    ...
                    str = "? " + iArr[i] + MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR;
                }
                str2 = sb2 + str;
                i++;
            }
    ...
    public static void dumpLayoutParams(ViewGroup viewGroup, String str) {
        StackTraceElement stackTraceElement = new Throwable().getStackTrace()[1];
        String str2 = ".(" + stackTraceElement.getFileName() + Constants.SUBS_ID_BASE_PLAN_ID_SEPARATOR + stackTraceElement.getLineNumber() + ") " + str + FileSpecKt.DEFAULT_INDENT;
